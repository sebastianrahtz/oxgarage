...
<xsl:stylesheet xmlns:a="http://schemas.openxmlformats.org/drawingml/2006/main"
    ...
    <doc xmlns="http://www.oxygenxml.com/ns/doc/xsl" scope="stylesheet" type="stylesheet">
      <desc>
         ...
         <p>Id: $Id: footnotes.xsl 7952 2010-08-12 21:14:51Z rahtz $</p>
	...
	<xsl:message>Writing out <xsl:value-of select="concat($word-directory,'/word/footnotes.xml')"/>    </xsl:message>
      </xsl:if>
