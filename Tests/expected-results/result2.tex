...
\par\bgroup\exampleFont\vskip 10pt\begin{shaded}
...
As an example, consider this extract from the quarto printing of Shakespeare's \textit{Henry V}. \par\bgroup\exampleFont\vskip 10pt\begin{shaded}
...
These elements may be used to record changes made by an editor, by the transcriber, or (in manuscript material) by the author or scribe. For example, if the source for an electronic text read \par\bgroup\exampleFont\vskip 10pt\begin{shaded}
...
If the source read\par\bgroup\exampleFont\vskip 10pt\begin{shaded}
...
It is recommended that the title should distinguish the computer file from the source text, for example: \par\bgroup\exampleFont\vskip 10pt\begin{shaded}
