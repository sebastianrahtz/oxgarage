...
\usepackage[pdftitle={Encoding for Interchange: an introduction to the TEI},
 pdfauthor={Lou Burnard and C. M. Sperberg-McQueen}]{hyperref}
\hyperbaseurl{}
\parskip0pt
\parindent1em
\@ifundefined{chapter}{%
...
\def\TheFullDate{2008-02-01}
\def\TheID{\makeatother }
\def\TheDate{2008-02-01}
\title{Encoding for Interchange: an introduction to the TEI}
\author{Lou Burnard and C. M. Sperberg-McQueen}\let\tabcellsep&
...
Encoding for Interchange: an introduction to the TEI
 — Revised for TEI P5 release}\author{Lou Burnard and C. M. Sperberg-McQueen}
  \date{February 2006}
  \maketitle
  \end{titlepage}
  \cleardoublepage

\DivI[Prefatory note]{Prefatory note}\label{U5-pref}\par TEI Lite was the name adopted for what the TEI editors originally
...
too heavy for their needs.\par The original TEI Lite was based largely on  observations of existing and
previous practice in the encoding of texts, particularly as manifest
in the collections of the \xref{http://ota.ahds.ac.uk}{Oxford
...
this shortish, readable, manual for it also helped.\par Early adopters of TEI Lite included a number of
‘Electronic Text Centers’, many of whom produced
their own documentation and tutorial materials (some examples are
listed in \xref{http://www.tei-c.org/Tutorials}{the TEI
...
translated (see further the list of versions at \url{http://www.tei-c.org/Lite/}).\par With the publication of TEI P4, the XML version of the TEI
...
this document is given below (changes). 

\begin{raggedleft}Lou Burnard, February 2006\end{raggedleft}

\mainmatter \par This document provides an introduction to the recommendations
...
TEI scheme, as defined by TEI document P5, \textit{Guidelines for
Electronic Text Encoding and Interchange}, as of February 2006,
and available from the TEI Consortium website at \url{http://www.tei-c.org}.
...
are needed (such as the accented letter \emph{a} in
\emph{faàl} or the long dash), it attempts to
mimic their appearance.\par \par\bgroup\ttfamily\small\selectfont \vskip 10pt\begin{shaded}
\obeylines\obeyspaces                           CHAPTER 38
...
\item Apostrophes are distinguished from quotation marks; direct
speech is explicitly marked.
\item The accented letter and the long dash are correctly represented.
\item Page divisions have been marked with an empty \texttt{<pb>}
element alone.
\item The lineation of the
...
removed.
\end{itemize} \par\bgroup\ttfamily\small\selectfont \begin{shaded}\noindent\mbox{}{<\textbf{pb}\hspace*{1em}n="{474}"/>}\mbox{}\newline 
{<\textbf{div}\hspace*{1em}n="{38}"\hspace*{1em}type="{chapter}">}\mbox{}\newline 
\hspace*{1em}{<\textbf{p}>}Reader, I married him. A quiet wedding we had: he and I,\mbox{}\newline 
\hspace*{1em}\hspace*{1em} the parson and clerk, were alone present. When we got back\mbox{}\newline 
\hspace*{1em}\hspace*{1em} from church, I went into the kitchen of the manor-house,\mbox{}\newline 
\hspace*{1em}\hspace*{1em} where Mary was cooking the dinner, and John cleaning the\mbox{}\newline 
\hspace*{1em}\hspace*{1em} knives, and I said —{</\textbf{p}>}\mbox{}\newline 
\hspace*{1em}{<\textbf{p}>}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}{<\textbf{q}>}Mary, I have been married to Mr Rochester this\mbox{}\newline 
...
\hspace*{1em}{<\textbf{p}>}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}{<\textbf{q}>}Have you, miss? Well, for sure!{</\textbf{q}>}\mbox{}\newline 
\hspace*{1em}{</\textbf{p}>}\mbox{}\newline 
\hspace*{1em}{<\textbf{p}>}A short time after she pursued, {<\textbf{q}>}I seed you go out with\mbox{}\newline 
...
\hspace*{1em}{<\textbf{p}>}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}{<\textbf{q}>}Thank you, John. Mr Rochester told me to give you and\mbox{}\newline 
\hspace*{1em}\hspace*{1em}\hspace*{1em}\hspace*{1em} Mary this.{</\textbf{q}>}\mbox{}\newline 
\hspace*{1em}{</\textbf{p}>}\mbox{}\newline 
\hspace*{1em}{<\textbf{p}>}I put into his hand a five-pound note. Without waiting\mbox{}\newline 
...
\hspace*{1em}{<\textbf{p}>}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}{<\textbf{q}>}She'll happen do better for him nor ony o' t' grand\mbox{}\newline 
...
\hspace*{1em}{</\textbf{p}>}\mbox{}\newline 
\hspace*{1em}{<\textbf{p}>}I wrote to Moor House and to Cambridge immediately, to\mbox{}\newline 
...
\hspace*{1em}{<\textbf{p}>}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}{<\textbf{q}>}She had better not wait till then, Jane,{</\textbf{q}>} said Mr\mbox{}\newline 
...
\hspace*{1em}{</\textbf{p}>}\mbox{}\newline 
\hspace*{1em}{<\textbf{p}>}How St John received the news I don't know: he never\mbox{}\newline 
...
\hspace*{1em}\hspace*{1em}{</\textbf{back}>}\mbox{}\newline 
\hspace*{1em}{</\textbf{text}>}\mbox{}\newline 
{</\textbf{TEI}>}\end{shaded}\egroup\par \par A composite text also has an optional front and back. In between
...
\par\bgroup\ttfamily\small\selectfont \begin{shaded}\noindent\mbox{}{<\textbf{teiCorpus}>}\mbox{}\newline 
\hspace*{1em}{<\textbf{teiHeader}>}\mbox{}\newline 
...
\hspace*{1em}{<\textbf{div}\hspace*{1em}n="{I}"\hspace*{1em}type="{book}"\hspace*{1em}xml:id="{WN1}">}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}{<\textbf{div}\hspace*{1em}n="{I.1}"\hspace*{1em}type="{chapter}"\hspace*{1em}xml:id="{WN101}">}\mbox{}\newline 
\textit{<!-- ... -->}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}{</\textbf{div}>}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}{<\textbf{div}\hspace*{1em}n="{I.2}"\hspace*{1em}type="{chapter}"\hspace*{1em}xml:id="{WN102}">}\mbox{}\newline 
\textit{<!-- ... -->}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}{</\textbf{div}>}\mbox{}\newline 
\textit{<!-- ... -->}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}{<\textbf{div}\hspace*{1em}n="{I.10}"\hspace*{1em}type="{chapter}"\hspace*{1em}xml:id="{WN110}">}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}\hspace*{1em}{<\textbf{div}\hspace*{1em}n="{I.10.1}"\hspace*{1em}type="{part}"\hspace*{1em}xml:id="{WN1101}">}\mbox{}\newline 
\textit{<!-- ... -->}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}\hspace*{1em}{</\textbf{div}>}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}\hspace*{1em}{<\textbf{div}\hspace*{1em}n="{I.10.2}"\hspace*{1em}type="{part}"\hspace*{1em}xml:id="{WN1102}">}\mbox{}\newline 
\textit{<!-- ... -->}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}\hspace*{1em}{</\textbf{div}>}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}{</\textbf{div}>}\mbox{}\newline 
\textit{<!-- ... -->}\mbox{}\newline 
\hspace*{1em}{</\textbf{div}>}\mbox{}\newline 
\hspace*{1em}{<\textbf{div}\hspace*{1em}n="{II}"\hspace*{1em}type="{book}"\hspace*{1em}xml:id="{WN2}">}\mbox{}\newline 
\textit{<!-- ... -->}\mbox{}\newline 
\hspace*{1em}{</\textbf{div}>}\mbox{}\newline 
...
\par\bgroup\ttfamily\small\selectfont \begin{shaded}\noindent\mbox{}{<\textbf{body}>}\mbox{}\newline 
\hspace*{1em}{<\textbf{div}\hspace*{1em}n="{1}"\hspace*{1em}type="{Volume}"\hspace*{1em}xml:id="{TS01}">}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}{<\textbf{div}\hspace*{1em}n="{1}"\hspace*{1em}type="{Chapter}"\hspace*{1em}xml:id="{TS011}">}\mbox{}\newline 
\textit{<!-- ... -->}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}{</\textbf{div}>}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}{<\textbf{div}\hspace*{1em}n="{2}"\hspace*{1em}xml:id="{TS012}">}\mbox{}\newline 
\textit{<!-- ... -->}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}{</\textbf{div}>}\mbox{}\newline 
\hspace*{1em}{</\textbf{div}>}\mbox{}\newline 
\hspace*{1em}{<\textbf{div}\hspace*{1em}n="{2}"\hspace*{1em}type="{Volume}"\hspace*{1em}xml:id="{TS02}">}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}{<\textbf{div}\hspace*{1em}n="{3}"\hspace*{1em}type="{Chapter}"\hspace*{1em}xml:id="{TS021}">}\mbox{}\newline 
\textit{<!-- ... -->}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}{</\textbf{div}>}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}{<\textbf{div}\hspace*{1em}n="{4}"\hspace*{1em}xml:id="{TS022}">}\mbox{}\newline 
\textit{<!-- ... -->}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}{</\textbf{div}>}\mbox{}\newline 
\hspace*{1em}{</\textbf{div}>}\mbox{}\newline 
...
\par\bgroup\ttfamily\small\selectfont \begin{shaded}\noindent\mbox{}{<\textbf{div}\hspace*{1em}n="{Winter}"\hspace*{1em}type="{Part}"\hspace*{1em}xml:id="{UGT1}">}\mbox{}\newline 
\hspace*{1em}{<\textbf{div}\hspace*{1em}n="{1}"\hspace*{1em}type="{Chapter}"\hspace*{1em}xml:id="{UGT11}">}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}{<\textbf{head}>}Mellstock-Lane{</\textbf{head}>}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}{<\textbf{p}>}To dwellers in a wood almost every species of tree ...\mbox{}\newline 
\hspace*{1em}\hspace*{1em}{</\textbf{p}>}\mbox{}\newline 
\hspace*{1em}{</\textbf{div}>}\mbox{}\newline 
{</\textbf{div}>}\end{shaded}\egroup\par 
\DivII[Prose, Verse and Drama]{Prose, Verse and Drama}\label{vedr}\par As noted above, the paragraphs making up a textual division should
be tagged with the \texttt{<p>} tag. For example:
...
{</\textbf{p}>}\end{shaded}\egroup\par \noindent \par A number of different tags are provided for the encoding of the
structural components of verse and performance texts (drama, film,
etc.):
\par Here, for example, is the start of a poetic text in which verse
lines and stanzas are tagged:
\par\bgroup\ttfamily\small\selectfont \begin{shaded}\noindent\mbox{}{<\textbf{lg}\hspace*{1em}n="{I}">}\mbox{}\newline 
\hspace*{1em}{<\textbf{l}>}I Sing the progresse of a\mbox{}\newline 
\hspace*{1em}\hspace*{1em} deathlesse soule,{</\textbf{l}>}\mbox{}\newline 
\hspace*{1em}{<\textbf{l}>}Whom Fate, with God made,\mbox{}\newline 
\hspace*{1em}\hspace*{1em} but doth not controule,{</\textbf{l}>}\mbox{}\newline 
\hspace*{1em}{<\textbf{l}>}Plac'd in most shapes; all times\mbox{}\newline 
\hspace*{1em}\hspace*{1em} before the law{</\textbf{l}>}\mbox{}\newline 
\hspace*{1em}{<\textbf{l}>}Yoak'd us, and when, and since,\mbox{}\newline 
\hspace*{1em}\hspace*{1em} in this I sing.{</\textbf{l}>}\mbox{}\newline 
\hspace*{1em}{<\textbf{l}>}And the great world to his aged evening;{</\textbf{l}>}\mbox{}\newline 
\hspace*{1em}{<\textbf{l}>}From infant morne, through manly noone I draw.{</\textbf{l}>}\mbox{}\newline 
\hspace*{1em}{<\textbf{l}>}What the gold Chaldee, of silver Persian saw,{</\textbf{l}>}\mbox{}\newline 
\hspace*{1em}{<\textbf{l}>}Greeke brass, or Roman iron, is in this one;{</\textbf{l}>}\mbox{}\newline 
\hspace*{1em}{<\textbf{l}>}A worke t'out weare Seths pillars, bricke and stone,{</\textbf{l}>}\mbox{}\newline 
\hspace*{1em}{<\textbf{l}>}And (holy writs excepted) made to yeeld to none,{</\textbf{l}>}\mbox{}\newline 
{</\textbf{lg}>}\end{shaded}\egroup\par \par Note that the \texttt{<l>} element marks verse lines, not typographic
...
\texttt{<lb>} element described in section \textit{\hyperref[U5-pln]{5. Page and Line Numbers}} may be
used to mark typographic lines if so desired.\par Sometimes, particularly in dramatic texts, verse lines are split
...
\par\bgroup\ttfamily\small\selectfont \begin{shaded}\noindent\mbox{}{<\textbf{div}\hspace*{1em}n="{I}"\hspace*{1em}type="{Act}">}\mbox{}\newline 
\hspace*{1em}{<\textbf{head}>}ACT I{</\textbf{head}>}\mbox{}\newline 
\hspace*{1em}{<\textbf{div}\hspace*{1em}n="{1}"\hspace*{1em}type="{Scene}">}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}{<\textbf{head}>}SCENE I{</\textbf{head}>}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}{<\textbf{stage}\hspace*{1em}rend="{italic}">}Enter Barnardo and Francisco, two Sentinels, at several doors{</\textbf{stage}>}\mbox{}\newline 
...
\hspace*{1em}\hspace*{1em}\hspace*{1em}{<\textbf{l}>}Nay, answer me. Stand and unfold\mbox{}\newline 
\hspace*{1em}\hspace*{1em}\hspace*{1em}\hspace*{1em}\hspace*{1em}\hspace*{1em} yourself.{</\textbf{l}>}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}{</\textbf{sp}>}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}{<\textbf{sp}>}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}\hspace*{1em}{<\textbf{speaker}>}Barn{</\textbf{speaker}>}\mbox{}\newline 
...
\hspace*{1em}\hspace*{1em}{<\textbf{sp}>}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}\hspace*{1em}{<\textbf{speaker}>}Fran{</\textbf{speaker}>}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}\hspace*{1em}{<\textbf{l}>}You come most carefully upon\mbox{}\newline 
...
\hspace*{1em}\hspace*{1em}{<\textbf{speaker}>}First voice{</\textbf{speaker}>}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}{<\textbf{lg}\hspace*{1em}part="{I}"\hspace*{1em}type="{stanza}">}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}\hspace*{1em}{<\textbf{l}>}But why drives on that ship so fast{</\textbf{l}>}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}\hspace*{1em}{<\textbf{l}>}Withouten wave or wind?{</\textbf{l}>}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}{</\textbf{lg}>}\mbox{}\newline 
\hspace*{1em}{</\textbf{sp}>}\mbox{}\newline 
\hspace*{1em}{<\textbf{sp}>}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}{<\textbf{speaker}>}Second Voice{</\textbf{speaker}>}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}{<\textbf{lg}\hspace*{1em}part="{F}">}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}\hspace*{1em}{<\textbf{l}>}The air is cut away before.{</\textbf{l}>}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}\hspace*{1em}{<\textbf{l}>}And closes from behind.{</\textbf{l}>}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}{</\textbf{lg}>}\mbox{}\newline 
\hspace*{1em}{</\textbf{sp}>}\mbox{}\newline 
\textit{<!-- ... -->}\mbox{}\newline 
{</\textbf{div}>}\end{shaded}\egroup\par \par This example shows how dialogue presented in a prose work as if it
...
\par\bgroup\ttfamily\small\selectfont \begin{shaded}\noindent\mbox{}{<\textbf{div}>}\mbox{}\newline 
\hspace*{1em}{<\textbf{sp}\hspace*{1em}who="{OPI}">}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}{<\textbf{speaker}>}The reverend Doctor Opimiam{</\textbf{speaker}>}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}{<\textbf{p}>}I do not think I have named a single unpresentable fish.{</\textbf{p}>}\mbox{}\newline 
\hspace*{1em}{</\textbf{sp}>}\mbox{}\newline 
\hspace*{1em}{<\textbf{sp}\hspace*{1em}who="{GRM}">}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}{<\textbf{speaker}>}Mr Gryll{</\textbf{speaker}>}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}{<\textbf{p}>}Bream, Doctor: there is not much to be said for bream.{</\textbf{p}>}\mbox{}\newline 
\hspace*{1em}{</\textbf{sp}>}\mbox{}\newline 
\hspace*{1em}{<\textbf{sp}\hspace*{1em}who="{OPI}">}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}{<\textbf{speaker}>}The Reverend Doctor Opimiam{</\textbf{speaker}>}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}{<\textbf{p}>}On the contrary, sir, I think there is much to be said for him.\mbox{}\newline 
\hspace*{1em}\hspace*{1em}\hspace*{1em}\hspace*{1em} In the first place....{</\textbf{p}>}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}{<\textbf{p}>}Fish, Miss Gryll -- I could discourse to you on fish by\mbox{}\newline 
...
of text. The global n attribute should be used to
supply the number of the page or line beginning at the tag. 
\par When working from a paginated original, it is often useful to
...
consideration.\par If pagination, etc., are marked for more than one edition, specify
the edition in question using the ed attribute, and
...
\par\bgroup\ttfamily\small\selectfont \begin{shaded}\noindent\mbox{}{<\textbf{p}>}I wrote to Moor House and to Cambridge immediately, to\mbox{}\newline 
 ...
 acted. Diana and {<\textbf{pb}\hspace*{1em}ed="{ED1}"\hspace*{1em}n="{475}"/>} Mary approved the\mbox{}\newline 
 step unreservedly. Diana announced that she would\mbox{}\newline 
{<\textbf{pb}\hspace*{1em}ed="{ED2}"\hspace*{1em}n="{485}"/>}just give me time to get over the\mbox{}\newline 
 honeymoon, and then she would come and see me.{</\textbf{p}>}\end{shaded}\egroup\par \par The \texttt{<pb>} and \texttt{<lb>} elements are special cases of
the general class of \emph{milestone} elements which mark
reference points within a text.  TEI Lite also includes a generic
\texttt{<milestone>} element, which is not restricted to special cases
...
should be documented in the header. The \texttt{<milestone>} element may
...
\DivII[Changes of Typeface, etc.]{Changes of Typeface, etc.}\label{faces}\par Highlighted words or phrases are those made visibly different from
...
some associated change.\par The global rend attribute can be attached to any
...
might be tagged \texttt{<head rend="bold">}, and one in
italic \texttt{<head rend="italic">}.\par It is not always possible or desirable to interpret the reasons
for such changes of rendering in a text.  In such cases, the element
\texttt{<hi>} may be used to mark a sequence of  highlighted text
without making any claim as to its status.
\par In the following example, the use of a distinct typeface for the
subheading and for the included name are recorded but not interpreted:
\par\bgroup\ttfamily\small\selectfont \begin{shaded}\noindent\mbox{}{<\textbf{p}>}\mbox{}\newline 
\hspace*{1em}{<\textbf{hi}\hspace*{1em}rend="{gothic}">}And this Indenture further witnesseth{</\textbf{hi}>}\mbox{}\newline 
...
{</\textbf{p}>}\end{shaded}\egroup\par \par Alternatively, where the cause for the highlighting can be
identified with confidence, a number of other, more specific, elements
are available.
\par Some features (notably quotations and glosses) may be found in a
text either marked by highlighting, or with quotation marks.  In
either case, the elements \texttt{<q>} and \texttt{<gloss>} (as
discussed in the following section) should be used. If the rendition
is to be recorded, use the global rend attribute.\par As an example of the elements defined here, consider the following
sentence:
 \begin{quote}
    On the one hand the \textit{Nibelungenlied}
is associated with the new rise of romance of twelfth-century France,
the \textit{romans d'antiquité}, the romances of Chrétien
de Troyes, and the German adaptations of these works by Heinrich van
Veldeke, Hartmann von Aue, and Wolfram von Eschenbach. \end{quote} Interpreting the role of the highlighting, the sentence might
look like this:
...
like this:
\par\bgroup\ttfamily\small\selectfont \begin{shaded}\noindent\mbox{}{<\textbf{p}>}On the one hand the {<\textbf{hi}\hspace*{1em}rend="{italic}">}Nibelungenlied{</\textbf{hi}>}\mbox{}\newline 
 is associated with the new rise of romance of twelfth-century\mbox{}\newline 
 France, the {<\textbf{hi}\hspace*{1em}rend="{italic}">}romans\mbox{}\newline 
\hspace*{1em}\hspace*{1em} d'antiquité{</\textbf{hi}>}, the romances of\mbox{}\newline 
 Chrétien de Troyes, ...{</\textbf{p}>}\end{shaded}\egroup\par 
\DivII[Quotations and Related Features]{Quotations and Related Features}\label{z635}\par Like changes of typeface, quotation marks are conventionally used
...
\par Here is a simple example of a quotation:
...
{</\textbf{p}>}\end{shaded}\egroup\par \par To record how a quotation was printed (for example,
\emph{in-line} or set off as a \emph{display} or
\emph{block quotation}), the rend attribute
should be used. This may also be used to indicate the kind of
quotation marks used.\par Direct speech interrupted by a narrator can be represented simply
by ending the quotation and beginning it again after the interruption,
as in the following example:
\par\bgroup\ttfamily\small\selectfont \begin{shaded}\noindent\mbox{}{<\textbf{p}>}\mbox{}\newline 
\hspace*{1em}{<\textbf{q}>}Who-e debel you?{</\textbf{q}>} — he at last said — {<\textbf{q}>}you\mbox{}\newline 
\hspace*{1em}\hspace*{1em} no speak-e, damme, I kill-e.{</\textbf{q}>} And so saying, the lighted\mbox{}\newline 
 tomahawk began flourishing about me in the dark.\mbox{}\newline 
{</\textbf{p}>}\end{shaded}\egroup\par \noindent 
If it is important to convey the idea that the two \texttt{<q>}
elements together make up a single speech, the linking attributes
next and
prev may be used, as described in section \textit{\hyperref[xatts]{8.3. Special kinds of Linking}}.\par Quotations may be accompanied by a reference to the source or
speaker, using the who attribute, whether or not the
source is given in the text, as in the following example:
\par\bgroup\ttfamily\small\selectfont \begin{shaded}\noindent\mbox{}{<\textbf{q}\hspace*{1em}who="{Wilson}">}Spaulding, he came down into the office just this\mbox{}\newline 
 day eight weeks with this very paper in his hand, and he\mbox{}\newline 
 says:—{<\textbf{q}\hspace*{1em}who="{Spaulding}">}I wish to the Lord, Mr. Wilson, that\mbox{}\newline 
\hspace*{1em}\hspace*{1em} I was a red-headed man.{</\textbf{q}>}\mbox{}\newline 
...
(Spaulding).\par The creator of the electronic text must decide whether quotation
...
in which they were rendered in the copy text.\par As with highlighting, it is not always possible and may not be
considered desirable to interpret the function of quotation marks in a
text in this way.  In such cases, the tag \texttt{<hi rend="quoted">}
might be used to mark quoted text without making any claim as to its
status.
\DivII[Foreign Words or Expressions]{Foreign Words or Expressions}\label{z636}\par Words or phrases which are not in the main language of the texts
...
value for the global xml:lang attribute indicating the
language used. Where there is no applicable element, the element
\texttt{<foreign>} may be used, again using the xml:lang
attribute.  For example:
\par\bgroup\ttfamily\small\selectfont \begin{shaded}\noindent\mbox{}{<\textbf{p}>}John has real\mbox{}\newline 
{<\textbf{foreign}\hspace*{1em}xml:lang="{fra}">}savoir-faire{</\textbf{foreign}>}.{</\textbf{p}>}\mbox{}\newline 
{<\textbf{p}>}Have you read {<\textbf{title}\hspace*{1em}xml:lang="{deu}">}Die Dreigroschenoper{</\textbf{title}>}?{</\textbf{p}>}\mbox{}\newline 
{<\textbf{p}>}\mbox{}\newline 
\hspace*{1em}{<\textbf{mentioned}\hspace*{1em}xml:lang="{fra}">}Savoir-faire{</\textbf{mentioned}>} is French for\mbox{}\newline 
 know-how.\mbox{}\newline 
{</\textbf{p}>}\mbox{}\newline 
{<\textbf{p}>}The court issued a writ of {<\textbf{term}\hspace*{1em}xml:lang="{lat}">}mandamus{</\textbf{term}>}.{</\textbf{p}>}\end{shaded}\egroup\par \par As these examples show, the \texttt{<foreign>} element should not
be used to tag foreign words if some other more specific element such
as \texttt{<title>}, \texttt{<mentioned>}, or \texttt{<term>} applies.
The global xml:lang attribute may be attached to any
element to show that it uses some other language than that of the
surrounding text.\par The codes used to identify languages, supplied on the
xml:lang attribute, must be constructed in a particular
way, and must conform to common Internet standards\footnote{The relevant standards are RFC 3066, and the lists of two
and three language identifiers maintained as part of ISO 639 (see http://www.w3.org/WAI/ER/IG/ert/iso639.htm)}, as further
...
\begin{longtable}{P{0.18133333333333335\textwidth}P{0.22666666666666666\textwidth}P{0.221\textwidth}P{0.221\textwidth}}
 \hline\endfoot\hline\endlastfoot zh or zho\tabcellsep Chinese\tabcellsep grc\tabcellsep Ancient Greek\\
...
{<\textbf{note}\hspace*{1em}n="{1}"\hspace*{1em}place="{foot}">}We explain below why we use the uncommon term\mbox{}\newline 
\hspace*{1em}{<\textbf{mentioned}>}collection{</\textbf{mentioned}>}\mbox{}\newline 
\hspace*{1em}\hspace*{1em} instead of the expected {<\textbf{mentioned}>}set{</\textbf{mentioned}>}.\mbox{}\newline 
\hspace*{1em}\hspace*{1em} Our usage corresponds to the {<\textbf{mentioned}>}aggregate{</\textbf{mentioned}>}\mbox{}\newline 
\hspace*{1em}\hspace*{1em} of many mathematical writings and to the sense of\mbox{}\newline 
\hspace*{1em}{<\textbf{mentioned}>}class{</\textbf{mentioned}>} found\mbox{}\newline 
\hspace*{1em}\hspace*{1em} in older logical writings.\mbox{}\newline 
\hspace*{1em}{</\textbf{note}>}\mbox{}\newline 
 The elements ...{</\textbf{p}>}\end{shaded}\egroup\par \noindent \par\bgroup\ttfamily\small\selectfont \begin{shaded}\noindent\mbox{}{<\textbf{lg}\hspace*{1em}xml:id="{RAM609}">}\mbox{}\newline 
\hspace*{1em}{<\textbf{note}\hspace*{1em}place="{margin}">}The curse is finally expiated{</\textbf{note}>}\mbox{}\newline 
\hspace*{1em}{<\textbf{l}>}And now this spell was snapt: once more{</\textbf{l}>}\mbox{}\newline 
\hspace*{1em}{<\textbf{l}>}I viewed the ocean green,{</\textbf{l}>}\mbox{}\newline 
\hspace*{1em}{<\textbf{l}>}And looked far forth, yet little saw{</\textbf{l}>}\mbox{}\newline 
\hspace*{1em}{<\textbf{l}>}Of what had else been seen —{</\textbf{l}>}\mbox{}\newline 
...
\par The difference between these two elements is that \texttt{<ptr>} is
an empty element, simply marking a point from which a link is to be
made, whereas \texttt{<ref>} may contain some text as well —
typically the text of the cross-reference itself. The \texttt{<ptr>}
...
reference.\par The following two forms, for example, are logically equivalent
(assuming we have documented somewhere the exact verbal form of cross
references represented by \texttt{<ptr>} elements):
\par\bgroup\ttfamily\small\selectfont \begin{shaded}\noindent\mbox{}See especially {<\textbf{ref}\hspace*{1em}target="{#SEC12}">}section 12 on page\mbox{}\newline 
 34{</\textbf{ref}>}.\end{shaded}\egroup\par \noindent \par\bgroup\ttfamily\small\selectfont \begin{shaded}\noindent\mbox{}See especially {<\textbf{ptr}\hspace*{1em}target="{#SEC12}"/>}.\end{shaded}\egroup\par \noindent   The value of the
...
\texttt{<div>} element:
\par\bgroup\ttfamily\small\selectfont \begin{shaded}\noindent\mbox{} ...\mbox{}\newline 
 see especially {<\textbf{ptr}\hspace*{1em}target="{#SEC12}"/>}.\mbox{}\newline 
 ...\mbox{}\newline 
\mbox{}\newline 
{<\textbf{div}\hspace*{1em}xml:id="{SEC12}">}\mbox{}\newline 
\hspace*{1em}{<\textbf{head}>}Concerning Identifiers{</\textbf{head}>}\mbox{}\newline 
\textit{<!-- ... -->}\mbox{}\newline 
{</\textbf{div}>}\end{shaded}\egroup\par \par Because the xml:id attribute is global, any element in
...
\par\bgroup\ttfamily\small\selectfont \begin{shaded}\noindent\mbox{} ...\mbox{}\newline 
 this is discussed in {<\textbf{ref}\hspace*{1em}target="{#pspec}">}the paragraph on links{</\textbf{ref}>}\mbox{}\newline 
 ...\mbox{}\newline 
\mbox{}\newline 
{<\textbf{p}\hspace*{1em}xml:id="{pspec}">}Links may be made to any kind of element\mbox{}\newline 
 ...{</\textbf{p}>}\end{shaded}\egroup\par \par Sometimes the target of a cross reference  does not correspond
...
\texttt{<anchor>} element at the appropriate spot. If the target is
some sequence of words not otherwise tagged, the \texttt{<seg>} element
may be introduced to mark them. These two elements are described as
follows:
\par In the following (imaginary) example, \texttt{<ref>} elements have
...
\par\bgroup\ttfamily\small\selectfont \begin{shaded}\noindent\mbox{} Returning to {<\textbf{ref}\hspace*{1em}target="{#ABCD}">}the point where I dozed\mbox{}\newline 
 off{</\textbf{ref}>}, I noticed that {<\textbf{ref}\hspace*{1em}target="{#EFGH}">}three\mbox{}\newline 
 words{</\textbf{ref}>} had been circled in red by a previous reader\end{shaded}\egroup\par \par This encoding requires that elements with the specified
identifiers (ABCD and EFGH in this
...
the \texttt{<anchor>} and
\texttt{<seg>} elements may be used:
\par\bgroup\ttfamily\small\selectfont \begin{shaded}\noindent\mbox{} .... {<\textbf{anchor}\hspace*{1em}type="{bookmark}"\hspace*{1em}xml:id="{ABCD}"/>} ....\mbox{}\newline 
 ....{<\textbf{seg}\hspace*{1em}type="{target}"\hspace*{1em}xml:id="{EFGH}">} ... {</\textbf{seg}>} ...\end{shaded}\egroup\par \par The type attribute should be used (as above) to
...
section \textit{\hyperref[xatts]{8.3. Special kinds of Linking}} below.
\DivII[Pointing to other documents]{Pointing to other documents}\label{xptrs}\par So far, we have shown how the elements \texttt{<ptr>} and
\texttt{<ref>} may be used for cross-references or links whose targets
...
target attribute may be any valid \emph{universal resource
...
\texttt{http://www.tei-c.org/index.xml}. \par A URL may reference a web page or just a part of one, for example
\texttt{http://www.tei-c.org/index.xml#SEC2}.  The sharp sign
...
document retrieved from \texttt{http://www.tei-c.org/index.xml}.
...
\par\bgroup\ttfamily\small\selectfont \begin{shaded}\noindent\mbox{}{<\textbf{seg}\hspace*{1em}ana="{SVO}"\hspace*{1em}type="{sentence}">}\mbox{}\newline 
\hspace*{1em}{<\textbf{seg}\hspace*{1em}ana="{#NP1}"\hspace*{1em}type="{lex}">}John{</\textbf{seg}>}\mbox{}\newline 
\hspace*{1em}{<\textbf{seg}\hspace*{1em}ana="{#VVI}"\hspace*{1em}type="{lex}">}loves{</\textbf{seg}>}\mbox{}\newline 
\hspace*{1em}{<\textbf{seg}\hspace*{1em}ana="{#NP1}"\hspace*{1em}type="{lex}">}Nancy{</\textbf{seg}>}\mbox{}\newline 
{</\textbf{seg}>}\end{shaded}\egroup\par \noindent   This encoding implies the existence elsewhere in the
document of elements with identifiers SVO, NP1,
and
VV1 where the significance of these particular codes
is explained. Note the use of the \texttt{<seg>} element to mark
particular components of the analysis, distinguished by the type
attribute.\par The corresp (corresponding) attribute provides a
...
\par\bgroup\ttfamily\small\selectfont \begin{shaded}\noindent\mbox{}{<\textbf{seg}\hspace*{1em}corresp="{#EN1}"\hspace*{1em}xml:id="{FR1}"\hspace*{1em}xml:lang="{fra}">}Jean aime Nancy{</\textbf{seg}>}\mbox{}\newline 
{<\textbf{seg}\hspace*{1em}corresp="{#FR1}"\hspace*{1em}xml:id="{EN1}"\hspace*{1em}xml:lang="{en}">}John loves Nancy{</\textbf{seg}>}\end{shaded}\egroup\par \par The same mechanism may be used for a variety of purposes. In the
following example, it has been used to represent anaphoric
correspondences between ‘the show’
and ‘Shirley’, and between
‘NBC’ and ‘the network’:
\par\bgroup\ttfamily\small\selectfont \begin{shaded}\noindent\mbox{}{<\textbf{p}>}\mbox{}\newline 
\hspace*{1em}{<\textbf{title}\hspace*{1em}xml:id="{shirley}">}Shirley{</\textbf{title}>}, which made\mbox{}\newline 
...
{</\textbf{p}>}\end{shaded}\egroup\par \par The next and prev attributes
provide a simple way of linking together the components of a
discontinuous  element, as in the following example:
\par\bgroup\ttfamily\small\selectfont \begin{shaded}\noindent\mbox{}{<\textbf{q}\hspace*{1em}next="{#Q1b}"\hspace*{1em}xml:id="{Q1a}">}Who-e debel you?{</\textbf{q}>}\mbox{}\newline 
 — he at last said — {<\textbf{q}\hspace*{1em}prev="{#Q1a}"\hspace*{1em}xml:id="{Q1b}">}you no speak-e,\mbox{}\newline 
...
\DivI[Editorial Interventions]{Editorial  Interventions}\label{U5-edit1}\par The process of encoding an electronic text has much in common with
...
\DivII[Correction and Normalization]{Correction and Normalization}\par The following elements may be used to mark
\emph{correction}, that is editorial changes introduced where
the editor believes the original to be erroneous:
\par The following elements may be used to mark
\emph{normalization}, that is editorial changes introduced for
the sake of consistency or modernization of a text:
\par As an example, consider this extract from the quarto printing of
Shakespeare's \textit{Henry V}. 
\par\bgroup\ttfamily\small\selectfont \vskip 10pt\begin{shaded}
\obeylines\obeyspaces  ... for his nose was as sharp as a pen and a table of green
feelds\end{shaded}
\par\egroup 

\par A modern editor might wish to make a number of interventions here,
specifically to modernize (or normalise) the Elizabethan spellings of 
\emph{a'} and
\emph{feelds} for \emph{he} and
\emph{fields} respectively. He or she might also want
to emend  \emph{table} to
\emph{babbl'd}, following an editorial tradition that
...
{<\textbf{corr}\hspace*{1em}resp="{#Theobald}">}babbl'd{</\textbf{corr}>} of green\mbox{}\newline 
\mbox{}\newline 
{<\textbf{reg}>}fields{</\textbf{reg}>}\end{shaded}\egroup\par \par A more conservative or source-oriented editor, however, might want
...
\mbox{}\newline 
{<\textbf{orig}>}feelds{</\textbf{orig}>}\end{shaded}\egroup\par \par Finally, a modern digital editor may decide to combine both
possibilities in a single composite text, using the \texttt{<choice>}
element.
...
{<\textbf{choice}>}\mbox{}\newline 
\hspace*{1em}{<\textbf{orig}>}a{</\textbf{orig}>}\mbox{}\newline 
\hspace*{1em}{<\textbf{reg}>}he{</\textbf{reg}>}\mbox{}\newline 
{</\textbf{choice}>}\mbox{}\newline 
{<\textbf{choice}>}\mbox{}\newline 
\hspace*{1em}{<\textbf{corr}\hspace*{1em}resp="{#Theobald}">}babbl'd{</\textbf{corr}>}\mbox{}\newline 
\hspace*{1em}{<\textbf{sic}>}table{</\textbf{sic}>}\mbox{}\newline 
{</\textbf{choice}>}\mbox{}\newline 
 of green\mbox{}\newline 
\mbox{}\newline 
{<\textbf{choice}>}\mbox{}\newline 
\hspace*{1em}{<\textbf{orig}>}feelds{</\textbf{orig}>}\mbox{}\newline 
\hspace*{1em}{<\textbf{reg}>}fields{</\textbf{reg}>}\mbox{}\newline 
{</\textbf{choice}>}\end{shaded}\egroup\par 
\DivII[Omissions, Deletions, and Additions]{Omissions, Deletions, and  Additions}\label{U5-edit2}\par In addition to correcting or normalizing words and phrases,
...
\par These elements may be used to record changes made by an editor, by
the transcriber, or (in manuscript material) by the author or scribe.
For example, if the source for an electronic text read

\par\bgroup\ttfamily\small\selectfont \vskip 10pt\begin{shaded}
\obeylines\obeyspaces The following elements are provided for for simple editorial
...
superfluous second \emph{for}, thus:

\par\bgroup\ttfamily\small\selectfont \begin{shaded}\noindent\mbox{}The following elements are provided for\mbox{}\newline 
{<\textbf{del}\hspace*{1em}resp="{#LB}">}for{</\textbf{del}>} simple editorial interventions.\end{shaded}\egroup\par \noindent  The attribute value \texttt{LB} on the resp
attribute indicates that ‘LB’
corrected the duplication of \emph{for}.\par If the source read\par\bgroup\ttfamily\small\selectfont \vskip 10pt\begin{shaded}
\obeylines\obeyspaces The following elements provided for
...
\par\bgroup\ttfamily\small\selectfont \begin{shaded}\noindent\mbox{}The following elements {<\textbf{add}\hspace*{1em}resp="{#LB}">}are{</\textbf{add}>} provided for\mbox{}\newline 
 simple editorial interventions.\end{shaded}\egroup\par \par These elements are not limited to changes made by an editor; they
...
\emph{galls} and inserted \emph{dogs}
might be encoded thus:
\par\bgroup\ttfamily\small\selectfont \begin{shaded}\noindent\mbox{}How it {<\textbf{del}\hspace*{1em}hand="{DHL}"\hspace*{1em}type="{overstrike}">}galls{</\textbf{del}>}\mbox{}\newline 
{<\textbf{add}\hspace*{1em}hand="{DHL}"\hspace*{1em}place="{supralinear}">}dogs{</\textbf{add}>} me,\mbox{}\newline 
 what a galling shadow\end{shaded}\egroup\par \par Similarly, the \texttt{<unclear>} and \texttt{<gap>} elements may be
used together to indicate the omission of illegible material; the
following example also shows the use of \texttt{<add>} for a
conjectural emendation:
\par\bgroup\ttfamily\small\selectfont \begin{shaded}\noindent\mbox{}One hundred & twenty good regulars joined to me\mbox{}\newline 
{<\textbf{unclear}>}\mbox{}\newline 
\hspace*{1em}{<\textbf{gap}\hspace*{1em}reason="{indecipherable}"/>}\mbox{}\newline 
{</\textbf{unclear}>}\mbox{}\newline 
 & instantly, would aid me signally {<\textbf{add}\hspace*{1em}hand="{ed}">}in?{</\textbf{add}>}\mbox{}\newline 
 an enterprise against Wilmington.\end{shaded}\egroup\par \par The \texttt{<del>} element marks material which is transcribed as
part of the electronic text despite being marked as deleted, while
\texttt{<gap>} marks the location of material which is omitted from the
...
{<\textbf{name}\hspace*{1em}type="{place}">}Koldinghus{</\textbf{name}>}\mbox{}\newline 
\hspace*{1em}{<\textbf{date}>}1611/12{</\textbf{date}>}\mbox{}\newline 
 is given below. It shows cash income from a sale of\mbox{}\newline 
 honey.{</\textbf{p}>}\mbox{}\newline 
{<\textbf{gap}>}\mbox{}\newline 
\hspace*{1em}{<\textbf{desc}>}quotation from ledger (in Danish){</\textbf{desc}>}\mbox{}\newline 
{</\textbf{gap}>}\mbox{}\newline 
{<\textbf{p}>}A description of the overall structure of the account is\mbox{}\newline 
 once again ... {</\textbf{p}>}\end{shaded}\egroup\par \par Other corpora (particular those constructed before the widespread
use of scanners) systematically omit figures and 
mathematics: \par\bgroup\ttfamily\small\selectfont \begin{shaded}\noindent\mbox{}{<\textbf{p}>}At the bottom of your screen below the mode line is the\mbox{}\newline 
{<\textbf{term}>}minibuffer{</\textbf{term}>}. This is the area where Emacs\mbox{}\newline 
 ...
 and so on.\mbox{}\newline 
{<\textbf{gap}\hspace*{1em}reason="{graphic}">}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}{<\textbf{desc}>}diagram of Emacs screen{</\textbf{desc}>}\mbox{}\newline 
\hspace*{1em}{</\textbf{gap}>}\mbox{}\newline 
{</\textbf{p}>}\end{shaded}\egroup\par 
\DivII[Abbreviations and their Expansion]{Abbreviations and their Expansion}\par Like names, dates, and numbers, abbreviations may be transcribed
as they stand or expanded; they may be left unmarked, or encoded using
the following elements:
\par The \texttt{<abbr>} element is useful as a means of distinguishing
...
{<\textbf{abbr}>}CC{</\textbf{abbr}>} is defined by that calibration of values which\mbox{}\newline 
 ...
 languages is currently nailing on {<\textbf{abbr}>}OOP{</\textbf{abbr}>} extensions\end{shaded}\egroup\par \par The type attribute may be used to distinguish
types of abbreviation by their function. \par The \texttt{<expan>} element is used to mark an expansion supplied by
...
representation for the word per is commonly encountered in
Medieval European manuscripts. An encoder may choose to expand this as
follows:
\par\bgroup\ttfamily\small\selectfont \begin{shaded}\noindent\mbox{}{<\textbf{expan}>}per{</\textbf{expan}>}\end{shaded}\egroup\par \par The expansion corresponding with an abbreviated form may not
...
signal which letters have been supplied. The \texttt{<expan>} element
...
abbreviation wt (for with) found in medieval
texts. In a modern edition, an editor might wish to represent this as
‘w\textbf{i}t\textbf{h}’, italicising the
...
{</\textbf{expan}>}\end{shaded}\egroup\par \par To record both an
abbreviation and its expansion, the \texttt{<choice>} element mentioned
above may be used to group the abbreviated form with its proposed
expansion: 
\par\bgroup\ttfamily\small\selectfont \begin{shaded}\noindent\mbox{}{<\textbf{choice}>}\mbox{}\newline 
\hspace*{1em}{<\textbf{abbr}>}wt{</\textbf{abbr}>}\mbox{}\newline 
\hspace*{1em}{<\textbf{expan}>}with{</\textbf{expan}>}\mbox{}\newline 
{</\textbf{choice}>}\end{shaded}\egroup\par 
\DivI[Names, Dates, and Numbers]{Names, Dates, and  Numbers}\label{U5-names}\par The TEI scheme defines elements for a large number of
‘data-like’ features which may appear almost
...
\DivII[Names and Referring Strings]{Names and Referring Strings}\label{nomen}\par A \emph{referring string} is a phrase which refers to some
person, place, object, etc. Two elements are provided to mark such
strings:

\par   The type attribute is used to distinguish
amongst (for example) names of persons, places and organizations,
where this is possible:
\par\bgroup\ttfamily\small\selectfont \begin{shaded}\noindent\mbox{}{<\textbf{q}>}My dear {<\textbf{rs}\hspace*{1em}type="{person}">}Mr. Bennet{</\textbf{rs}>}, {</\textbf{q}>}\mbox{}\newline 
 said his lady to him one day, \mbox{}\newline 
{<\textbf{q}>}have you heard\mbox{}\newline 
 that {<\textbf{rs}\hspace*{1em}type="{place}">}Netherfield Park{</\textbf{rs}>} is let\mbox{}\newline 
 at last?{</\textbf{q}>}\end{shaded}\egroup\par \noindent \par\bgroup\ttfamily\small\selectfont \begin{shaded}\noindent\mbox{}It being one of the principles of the\mbox{}\newline 
{<\textbf{rs}\hspace*{1em}type="{organization}">}Circumlocution Office{</\textbf{rs}>} never,\mbox{}\newline 
 on any account whatsoever, to give a straightforward answer,\mbox{}\newline 
{<\textbf{rs}\hspace*{1em}type="{person}">}Mr Barnacle{</\textbf{rs}>} said, \mbox{}\newline 
{<\textbf{q}>}Possibly.{</\textbf{q}>}\end{shaded}\egroup\par \par As the following example shows, the \texttt{<rs>} element may be
used for any reference to a person, place, etc, not necessarily one in
the form of a proper noun or noun phrase.
\par\bgroup\ttfamily\small\selectfont \begin{shaded}\noindent\mbox{}{<\textbf{q}>}My dear {<\textbf{rs}\hspace*{1em}type="{person}">}Mr. Bennet{</\textbf{rs}>},{</\textbf{q}>}\mbox{}\newline 
 said {<\textbf{rs}\hspace*{1em}type="{person}">}his lady{</\textbf{rs}>} to him\mbox{}\newline 
 one day...\end{shaded}\egroup\par \par The \texttt{<name>} element by contrast is provided for the special
case of referencing strings which consist only of proper nouns; it may
be used synonymously with the \texttt{<rs>} element, or nested within
it if a referring string contains a mixture of common and proper
nouns.\par Simply tagging something as a name is rarely enough to
...
prefixes such as \emph{van} or \emph{de la},
 may or may not be included as part of the reference form of a name,
depending on the language and country of origin of the bearer.\par The key  attribute provides an alternative normalized identifier for the object being named,
...
\par\bgroup\ttfamily\small\selectfont \begin{shaded}\noindent\mbox{}{<\textbf{q}>}My dear {<\textbf{rs}\hspace*{1em}key="{BENM1}"\hspace*{1em}type="{person}">}Mr. Bennet{</\textbf{rs}>},\mbox{}\newline 
{</\textbf{q}>} said {<\textbf{rs}\hspace*{1em}key="{BENM2}"\hspace*{1em}type="{person}">}his lady{</\textbf{rs}>}\mbox{}\newline 
 to him one day, \mbox{}\newline 
{<\textbf{q}>}have you heard that\mbox{}\newline 
{<\textbf{rs}\hspace*{1em}key="{NETP1}"\hspace*{1em}type="{place}">}Netherfield Park{</\textbf{rs}>}\mbox{}\newline 
 is let at last?{</\textbf{q}>}\end{shaded}\egroup\par \par This use should be distinguished from the case of the
\texttt{<reg>} (regularization) element, which provides a means
of marking the standard form of a referencing string as demonstrated
below:
\par\bgroup\ttfamily\small\selectfont \begin{shaded}\noindent\mbox{}{<\textbf{name}\hspace*{1em}key="{WADLM1}"\hspace*{1em}type="{person}">}\mbox{}\newline 
\hspace*{1em}{<\textbf{choice}>}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}{<\textbf{sic}>}Walter de la Mare{</\textbf{sic}>}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}{<\textbf{reg}>}de la Mare, Walter{</\textbf{reg}>}\mbox{}\newline 
\hspace*{1em}{</\textbf{choice}>}\mbox{}\newline 
{</\textbf{name}>} was born at\mbox{}\newline 
{<\textbf{name}\hspace*{1em}key="{Ch1}"\hspace*{1em}type="{place}">}Charlton{</\textbf{name}>}, in\mbox{}\newline 
{<\textbf{name}\hspace*{1em}key="{KT1}"\hspace*{1em}type="{county}">}Kent{</\textbf{name}>}, in 1873.\end{shaded}\egroup\par \par The \texttt{<index>} element discussed in \url{indexing} may be
...
{<\textbf{name}\hspace*{1em}type="{person}">}Fournier{</\textbf{name}>}'s {<\textbf{index}>}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}{<\textbf{term}>}Benedict XII, Pope of Avignon (Jacques Fournier){</\textbf{term}>}\mbox{}\newline 
...
Guidelines provide a range of other solutions.
\DivII[Dates and Times]{Dates and Times}\par Tags for the more detailed encoding of times and dates include the
following:
\par The value attribute specifies a normalized form
for the date or time, using one of the standard formats defined by  ISO 8601.
Partial dates or times (e.g. ‘1990’,
‘September 1990’,
‘twelvish’) can  be expressed
by  omitting a part of the value supplied, as in the following examples:
\par\bgroup\ttfamily\small\selectfont \begin{shaded}\noindent\mbox{}{<\textbf{date}\hspace*{1em}when="{1980-02-21}">}21 Feb 1980{</\textbf{date}>}\mbox{}\newline 
{<\textbf{date}\hspace*{1em}when="{1990}">}1990{</\textbf{date}>}\mbox{}\newline 
{<\textbf{date}\hspace*{1em}when="{1990-09}">}September 1990{</\textbf{date}>}\mbox{}\newline 
{<\textbf{date}\hspace*{1em}when="{--09}">}September{</\textbf{date}>}\mbox{}\newline 
{<\textbf{date}\hspace*{1em}when="{2001-09-11T12:48:00}">}Sept 11th, 12 minutes before 9 am{</\textbf{date}>}\end{shaded}\egroup\par \noindent Note in the last example the use of a normalized representation for
the date string which includes a time: this example could thus equally
well be tagged using the \texttt{<time>} element. 
\par \par\bgroup\ttfamily\small\selectfont \begin{shaded}\noindent\mbox{}Given on the {<\textbf{date}\hspace*{1em}when="{1977-06-12}">}Twelfth Day of June\mbox{}\newline 
...
{<\textbf{l}>}and {<\textbf{time}\hspace*{1em}when="{15:00:00}">}three o'clock in the\mbox{}\newline 
\hspace*{1em}\hspace*{1em} afternoon{</\textbf{time}>}\mbox{}\newline 
{</\textbf{l}>}\end{shaded}\egroup\par 
\DivII[Numbers]{Numbers }\par Numbers can be written with either letters or digits (\texttt{twenty-one},
\texttt{xxi}, and \texttt{21}) and their presentation is
language-dependent (e.g. English \emph{5th} becomes
Greek \emph{5.}; English \emph{123,456.78}
equals French
\emph{123.456,78}). In natural-language processing or
...
standard notation is important. The \texttt{<num>} element provides
this possibility:
\par For example:
...
\DivI[Lists]{Lists}\label{U5-lists}\par The element \texttt{<list>} is used to mark any kind of
\emph{list}.  A list is a sequence of text items, which may be
...
defined):
\par Individual list items are tagged with \texttt{<item>}.  The first
\texttt{<item>} may optionally be preceded by a \texttt{<head>}, which
gives a heading for the list.  The numbering of a list may be omitted, indicated using the n attribute
on each item, or (rarely) tagged as content using the \texttt{<label>}
element.  The following are all thus equivalent:
\par\bgroup\ttfamily\small\selectfont \begin{shaded}\noindent\mbox{}{<\textbf{list}>}\mbox{}\newline 
\hspace*{1em}{<\textbf{head}>}A short list{</\textbf{head}>}\mbox{}\newline 
\hspace*{1em}{<\textbf{item}>}First item in list.{</\textbf{item}>}\mbox{}\newline 
\hspace*{1em}{<\textbf{item}>}Second item in list.{</\textbf{item}>}\mbox{}\newline 
\hspace*{1em}{<\textbf{item}>}Third item in list.{</\textbf{item}>}\mbox{}\newline 
{</\textbf{list}>}\mbox{}\newline 
{<\textbf{list}>}\mbox{}\newline 
\hspace*{1em}{<\textbf{head}>}A short list{</\textbf{head}>}\mbox{}\newline 
\hspace*{1em}{<\textbf{item}\hspace*{1em}n="{1}">}First item in list.{</\textbf{item}>}\mbox{}\newline 
\hspace*{1em}{<\textbf{item}\hspace*{1em}n="{2}">}Second item in list.{</\textbf{item}>}\mbox{}\newline 
\hspace*{1em}{<\textbf{item}\hspace*{1em}n="{3}">}Third item in list.{</\textbf{item}>}\mbox{}\newline 
{</\textbf{list}>}\mbox{}\newline 
{<\textbf{list}>}\mbox{}\newline 
\hspace*{1em}{<\textbf{head}>}A short list{</\textbf{head}>}\mbox{}\newline 
...
\hspace*{1em}{<\textbf{item}>}Second item in list.{</\textbf{item}>}\mbox{}\newline 
\hspace*{1em}{<\textbf{label}>}3{</\textbf{label}>}\mbox{}\newline 
\hspace*{1em}{<\textbf{item}>}Third item in list.{</\textbf{item}>}\mbox{}\newline 
...
\hspace*{1em}{<\textbf{head}>}Vocabulary{</\textbf{head}>}\mbox{}\newline 
\hspace*{1em}{<\textbf{label}\hspace*{1em}xml:lang="{enm}">}nu{</\textbf{label}>}\mbox{}\newline 
\hspace*{1em}{<\textbf{item}>}now{</\textbf{item}>}\mbox{}\newline 
\hspace*{1em}{<\textbf{label}\hspace*{1em}xml:lang="{enm}">}lhude{</\textbf{label}>}\mbox{}\newline 
\hspace*{1em}{<\textbf{item}>}loudly{</\textbf{item}>}\mbox{}\newline 
\hspace*{1em}{<\textbf{label}\hspace*{1em}xml:lang="{enm}">}bloweth{</\textbf{label}>}\mbox{}\newline 
\hspace*{1em}{<\textbf{item}>}blooms{</\textbf{item}>}\mbox{}\newline 
\hspace*{1em}{<\textbf{label}\hspace*{1em}xml:lang="{enm}">}med{</\textbf{label}>}\mbox{}\newline 
\hspace*{1em}{<\textbf{item}>}meadow{</\textbf{item}>}\mbox{}\newline 
\hspace*{1em}{<\textbf{label}\hspace*{1em}xml:lang="{enm}">}wude{</\textbf{label}>}\mbox{}\newline 
\hspace*{1em}{<\textbf{item}>}wood{</\textbf{item}>}\mbox{}\newline 
\hspace*{1em}{<\textbf{label}\hspace*{1em}xml:lang="{enm}">}awe{</\textbf{label}>}\mbox{}\newline 
\hspace*{1em}{<\textbf{item}>}ewe{</\textbf{item}>}\mbox{}\newline 
\hspace*{1em}{<\textbf{label}\hspace*{1em}xml:lang="{enm}">}lhouth{</\textbf{label}>}\mbox{}\newline 
\hspace*{1em}{<\textbf{item}>}lows{</\textbf{item}>}\mbox{}\newline 
\hspace*{1em}{<\textbf{label}\hspace*{1em}xml:lang="{enm}">}sterteth{</\textbf{label}>}\mbox{}\newline 
\hspace*{1em}{<\textbf{item}>}bounds, frisks{</\textbf{item}>}\mbox{}\newline 
\hspace*{1em}{<\textbf{label}\hspace*{1em}xml:lang="{enm}">}verteth{</\textbf{label}>}\mbox{}\newline 
\hspace*{1em}{<\textbf{item}\hspace*{1em}xml:lang="{lat}">}pedit{</\textbf{item}>}\mbox{}\newline 
\hspace*{1em}{<\textbf{label}\hspace*{1em}xml:lang="{enm}">}murie{</\textbf{label}>}\mbox{}\newline 
\hspace*{1em}{<\textbf{item}>}merrily{</\textbf{item}>}\mbox{}\newline 
\hspace*{1em}{<\textbf{label}\hspace*{1em}xml:lang="{enm}">}swik{</\textbf{label}>}\mbox{}\newline 
\hspace*{1em}{<\textbf{item}>}cease{</\textbf{item}>}\mbox{}\newline 
\hspace*{1em}{<\textbf{label}\hspace*{1em}xml:lang="{enm}">}naver{</\textbf{label}>}\mbox{}\newline 
\hspace*{1em}{<\textbf{item}>}never{</\textbf{item}>}\mbox{}\newline 
...
which special-purpose tagging is defined below (\textit{\hyperref[U5-tables]{13. Tables}}).
\par Lists of whatever kind can, of course, nest within list items to
...
\hspace*{1em}\hspace*{1em}{<\textbf{list}\hspace*{1em}type="{simple}">}\mbox{}\newline 
...
\par\bgroup\ttfamily\small\selectfont \begin{shaded}\noindent\mbox{}{<\textbf{p}>}On those remote pages it is written that animals are\mbox{}\newline 
 divided into {<\textbf{list}\hspace*{1em}rend="{run-on}">}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}{<\textbf{item}\hspace*{1em}n="{a}">}those that belong to the\mbox{}\newline 
\hspace*{1em}\hspace*{1em}\hspace*{1em}\hspace*{1em} Emperor,{</\textbf{item}>}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}{<\textbf{item}\hspace*{1em}n="{b}">} embalmed ones, {</\textbf{item}>}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}{<\textbf{item}\hspace*{1em}n="{c}">} those\mbox{}\newline 
\hspace*{1em}\hspace*{1em}\hspace*{1em}\hspace*{1em} that are trained, {</\textbf{item}>}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}{<\textbf{item}\hspace*{1em}n="{d}">} suckling pigs, {</\textbf{item}>}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}{<\textbf{item}\hspace*{1em}n="{e}">}mermaids, {</\textbf{item}>}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}{<\textbf{item}\hspace*{1em}n="{f}">} fabulous ones, {</\textbf{item}>}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}{<\textbf{item}\hspace*{1em}n="{g}">} stray\mbox{}\newline 
\hspace*{1em}\hspace*{1em}\hspace*{1em}\hspace*{1em} dogs, {</\textbf{item}>}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}{<\textbf{item}\hspace*{1em}n="{h}">} those that are included in this\mbox{}\newline 
\hspace*{1em}\hspace*{1em}\hspace*{1em}\hspace*{1em} classification, {</\textbf{item}>}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}{<\textbf{item}\hspace*{1em}n="{i}">} those that tremble as if they\mbox{}\newline 
\hspace*{1em}\hspace*{1em}\hspace*{1em}\hspace*{1em} were mad, {</\textbf{item}>}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}{<\textbf{item}\hspace*{1em}n="{j}">} innumerable ones, {</\textbf{item}>}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}{<\textbf{item}\hspace*{1em}n="{k}">} those\mbox{}\newline 
\hspace*{1em}\hspace*{1em}\hspace*{1em}\hspace*{1em} drawn with a very fine camel's-hair brush, {</\textbf{item}>}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}{<\textbf{item}\hspace*{1em}n="{l}">}others, {</\textbf{item}>}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}{<\textbf{item}\hspace*{1em}n="{m}">} those that have just broken a flower\mbox{}\newline 
\hspace*{1em}\hspace*{1em}\hspace*{1em}\hspace*{1em} vase, {</\textbf{item}>}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}{<\textbf{item}\hspace*{1em}n="{n}">} those that resemble flies from a\mbox{}\newline 
...
1445, and died March 14, 1470 (according to Kittredge, \textit{Harvard
Studies} 5. 88ff). \end{quote}\par\bgroup\ttfamily\small\selectfont \begin{shaded}\noindent\mbox{}He was a member of Parliament for Warwickshire in 1445, and died\mbox{}\newline 
 March 14, 1470 (according to {<\textbf{bibl}>}\mbox{}\newline 
\hspace*{1em}{<\textbf{author}>}Kittredge{</\textbf{author}>},\mbox{}\newline 
{<\textbf{title}>}Harvard Studies{</\textbf{title}>}\mbox{}\newline 
\hspace*{1em}{<\textbf{biblScope}>}5. 88ff{</\textbf{biblScope}>}\mbox{}\newline 
{</\textbf{bibl}>}).\end{shaded}\egroup\par \par For lists of bibliographic citations, the \texttt{<listBibl>}
element should be used; it may contain a series of \texttt{<bibl>}
elements.  
\DivI[Tables]{Tables}\label{U5-tables}\par Tables represent a  challenge for any text processing
...
\par For example, Defoe uses mortality tables like the following in the
\textit{Journal of the Plague Year} to show the rise
and ebb of the epidemic:\par\bgroup\ttfamily\small\selectfont \begin{shaded}\noindent\mbox{}{<\textbf{p}>}It was indeed coming on amain, for the burials that\mbox{}\newline 
 same week were in the next adjoining parishes thus:—\mbox{}\newline 
{<\textbf{table}\hspace*{1em}cols="{4}"\hspace*{1em}rows="{5}">}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}{<\textbf{row}\hspace*{1em}role="{data}">}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}\hspace*{1em}{<\textbf{cell}\hspace*{1em}role="{label}">}St. Leonard's, Shoreditch{</\textbf{cell}>}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}\hspace*{1em}{<\textbf{cell}>}64{</\textbf{cell}>}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}\hspace*{1em}{<\textbf{cell}>}84{</\textbf{cell}>}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}\hspace*{1em}{<\textbf{cell}>}119{</\textbf{cell}>}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}{</\textbf{row}>}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}{<\textbf{row}\hspace*{1em}role="{data}">}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}\hspace*{1em}{<\textbf{cell}\hspace*{1em}role="{label}">}St. Botolph's, Bishopsgate{</\textbf{cell}>}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}\hspace*{1em}{<\textbf{cell}>}65{</\textbf{cell}>}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}\hspace*{1em}{<\textbf{cell}>}105{</\textbf{cell}>}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}\hspace*{1em}{<\textbf{cell}>}116{</\textbf{cell}>}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}{</\textbf{row}>}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}{<\textbf{row}\hspace*{1em}role="{data}">}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}\hspace*{1em}{<\textbf{cell}\hspace*{1em}role="{label}">}St. Giles's, Cripplegate{</\textbf{cell}>}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}\hspace*{1em}{<\textbf{cell}>}213{</\textbf{cell}>}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}\hspace*{1em}{<\textbf{cell}>}421{</\textbf{cell}>}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}\hspace*{1em}{<\textbf{cell}>}554{</\textbf{cell}>}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}{</\textbf{row}>}\mbox{}\newline 
\hspace*{1em}{</\textbf{table}>}\mbox{}\newline 
{</\textbf{p}>}\mbox{}\newline 
...
\DivI[Figures and Graphics]{Figures and Graphics}\label{U5-figs}\par Not all the components of a document are necessarily textual. The
...
complementary. \par The encoder may simply record the presence of a graphic within the
...
document.
\par Any textual information accompanying the graphic, such as a
heading and/or caption, may be included within the \texttt{<figure>}
element itself, in a \texttt{<head>} and one or more \texttt{<p>}
...
supplied, as the content of a \texttt{<figDesc>} element, for the use
...
is not normally considered part of the document proper.)\par The simplest use for these elements is to mark the position of a
graphic and provide a link to it, as in this example;
\par\bgroup\ttfamily\small\selectfont \begin{shaded}\noindent\mbox{}{<\textbf{pb}\hspace*{1em}n="{412}"/>}\mbox{}\newline 
{<\textbf{graphic}\hspace*{1em}url="{p412fig.png}"/>}\mbox{}\newline 
{<\textbf{pb}\hspace*{1em}n="{413}"/>}\end{shaded}\egroup\par \noindent 
This indicates that the graphic contained by the file
\textsf{p412fig.png} appears between pages 412 and 413. \par The \texttt{<graphic>} element can appear
...
\hspace*{1em}{<\textbf{graphic}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}\hspace*{1em}url="{http://www.iath.virginia.edu/gants/Ornaments/Heads/hp-ral02.gif}"/>}\mbox{}\newline 
{</\textbf{head}>}\end{shaded}\egroup\par \par More usually, a graphic will have at the
least an identifying title, which may be encoded using the \texttt{<head>}
...
the image.  The \texttt{<figure>} element provides a means of wrapping
one or more such elements together as a kind of graphic
‘block’:
\par\bgroup\ttfamily\small\selectfont \begin{shaded}\noindent\mbox{}{<\textbf{figure}>}\mbox{}\newline 
\hspace*{1em}{<\textbf{graphic}\hspace*{1em}url="{fessipic.png}"/>}\mbox{}\newline 
\hspace*{1em}{<\textbf{head}>}Mr Fezziwig's Ball{</\textbf{head}>}\mbox{}\newline 
\hspace*{1em}{<\textbf{figDesc}>}A Cruikshank engraving showing Mr Fezziwig leading\mbox{}\newline 
\hspace*{1em}\hspace*{1em} a group of revellers.{</\textbf{figDesc}>}\mbox{}\newline 
{</\textbf{figure}>}\end{shaded}\egroup\par \par When a digitized version of the graphic concerned is available, it
may be  embedded  at the appropriate point within the
document in this way.
\DivI[Interpretation and Analysis]{Interpretation and  Analysis}\label{U5-anal}\par It is often said that \textit{all} markup is a form of
...
elements provided by the TEI scheme to meet this need. 
\DivII[Orthographic Sentences]{Orthographic Sentences}\par Interpretation typically ranges across the whole of a text, with
...
for use as a sort of ‘canonical reference’.  To
...
following element:
\par As the name suggests, the \texttt{<s>} element is most commonly
used (in linguistic applications at least) for marking \emph{orthographic
sentences}, that is, units defined by orthographic features such
as punctuation.  For example, the passage from
\textit{Jane Eyre} discussed earlier might be divided into
s-units as follows:\par\bgroup\ttfamily\small\selectfont \begin{shaded}\noindent\mbox{}{<\textbf{pb}\hspace*{1em}n="{474}"/>}\mbox{}\newline 
{<\textbf{div}\hspace*{1em}n="{38}"\hspace*{1em}type="{chapter}">}\mbox{}\newline 
\hspace*{1em}{<\textbf{p}>}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}{<\textbf{s}\hspace*{1em}n="{001}">}Reader, I married him.{</\textbf{s}>}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}{<\textbf{s}\hspace*{1em}n="{002}">}A quiet wedding we had:{</\textbf{s}>}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}{<\textbf{s}\hspace*{1em}n="{003}">}he and I, the parson and clerk, were alone present.{</\textbf{s}>}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}{<\textbf{s}\hspace*{1em}n="{004}">}When we got back from church, I went\mbox{}\newline 
\hspace*{1em}\hspace*{1em}\hspace*{1em}\hspace*{1em} into the kitchen of the manor-house, where Mary was cooking\mbox{}\newline 
...
\hspace*{1em}\hspace*{1em}\hspace*{1em}{<\textbf{s}\hspace*{1em}n="{005}">}Mary, I have been married to Mr Rochester\mbox{}\newline 
\hspace*{1em}\hspace*{1em}\hspace*{1em}\hspace*{1em}\hspace*{1em}\hspace*{1em} this morning.{</\textbf{s}>}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}{</\textbf{q}>} ... {</\textbf{p}>}\mbox{}\newline 
{</\textbf{div}>}\end{shaded}\egroup\par \noindent  
Note that  \texttt{<s>}
...
\DivII[General-Purpose Interpretation Elements]{General-Purpose Interpretation Elements}\par A more general purpose segmentation element, the \texttt{<seg>} has
  already been introduced for use in identifying otherwise unmarked
  targets of cross references and hypertext links (see section \textit{\hyperref[U5-ptrs]{8. Cross References and Links}}); it identifies some phrase-level portion of text
  to which the encoder may assign a user-specified type, as
  ...
  Guidelines.\par For example, the Guidelines provide no
  ‘apostrophe’ element to mark parts of a literary
  ...
  \texttt{<q>} element, distinguished from others by an appropriate
  value for the who attribute. A possibly simpler, and
  certainly more general, solution would however be to use the
  \texttt{<seg>} element as follows:

\par\bgroup\ttfamily\small\selectfont \begin{shaded}\noindent\mbox{}{<\textbf{div}\hspace*{1em}n="{38}"\hspace*{1em}type="{chapter}">}\mbox{}\newline 
\hspace*{1em}{<\textbf{p}>}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}{<\textbf{seg}\hspace*{1em}type="{apostrophe}">}Reader, I married him.{</\textbf{seg}>}\mbox{}\newline 
\hspace*{1em}\hspace*{1em} A quiet wedding we had: ...{</\textbf{p}>}\mbox{}\newline 
{</\textbf{div}>}\end{shaded}\egroup\par \noindent  
...
\hspace*{1em}{<\textbf{div}\hspace*{1em}type="{Interpretations}">}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}{<\textbf{p}>}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}\hspace*{1em}{<\textbf{interp}\hspace*{1em}resp="{#LB-MSM}"\hspace*{1em}type="{figureOfSpeech}"\hspace*{1em}xml:id="{fig-apos-1}">}apostrophe{</\textbf{interp}>}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}\hspace*{1em}{<\textbf{interp}\hspace*{1em}resp="{#LB-MSM}"\hspace*{1em}type="{figureOfSpeech}"\hspace*{1em}xml:id="{fig-hyp-1}">}hyperbole{</\textbf{interp}>}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}\hspace*{1em}{<\textbf{interp}\hspace*{1em}resp="{#LB-MSM}"\hspace*{1em}type="{setting}"\hspace*{1em}xml:id="{set-church-1}">}church{</\textbf{interp}>}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}\hspace*{1em}{<\textbf{interp}\hspace*{1em}resp="{#LB-MSM}"\hspace*{1em}type="{reference}"\hspace*{1em}xml:id="{ref-church-1}">}church{</\textbf{interp}>}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}\hspace*{1em}{<\textbf{interp}\hspace*{1em}resp="{#LB-MSM}"\hspace*{1em}type="{reference}"\hspace*{1em}xml:id="{ref-serv-1}">}servants{</\textbf{interp}>}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}{</\textbf{p}>}\mbox{}\newline 
\hspace*{1em}{</\textbf{div}>}\mbox{}\newline 
{</\textbf{back}>}\end{shaded}\egroup\par \par The evident redundancy of this encoding can be considerably
reduced by using the \texttt{<interpGrp>} element to group together all
those \texttt{<interp>} elements which share common attribute values,
as follows: 
\par\bgroup\ttfamily\small\selectfont \begin{shaded}\noindent\mbox{}{<\textbf{back}>}\mbox{}\newline 
\hspace*{1em}{<\textbf{div}\hspace*{1em}type="{Interpretations}">}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}{<\textbf{p}>}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}\hspace*{1em}{<\textbf{interpGrp}\hspace*{1em}resp="{#LB-MSM}"\hspace*{1em}type="{figureOfSpeech}">}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}\hspace*{1em}\hspace*{1em}{<\textbf{interp}\hspace*{1em}xml:id="{fig-apos}">}apostrophe{</\textbf{interp}>}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}\hspace*{1em}\hspace*{1em}{<\textbf{interp}\hspace*{1em}xml:id="{fig-hyp}">}hyperbole{</\textbf{interp}>}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}\hspace*{1em}\hspace*{1em}{<\textbf{interp}\hspace*{1em}xml:id="{fig-meta}">}metaphor{</\textbf{interp}>}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}\hspace*{1em}{</\textbf{interpGrp}>}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}\hspace*{1em}{<\textbf{interpGrp}\hspace*{1em}resp="{#LB-MSM}"\hspace*{1em}type="{scene-setting}">}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}\hspace*{1em}\hspace*{1em}{<\textbf{interp}\hspace*{1em}xml:id="{set-church}">}church{</\textbf{interp}>}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}\hspace*{1em}\hspace*{1em}{<\textbf{interp}\hspace*{1em}xml:id="{set-kitch}">}kitchen{</\textbf{interp}>}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}\hspace*{1em}\hspace*{1em}{<\textbf{interp}\hspace*{1em}xml:id="{set-unspec}">}unspecified{</\textbf{interp}>}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}\hspace*{1em}{</\textbf{interpGrp}>}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}\hspace*{1em}{<\textbf{interpGrp}\hspace*{1em}resp="{#LB-MSM}"\hspace*{1em}type="{reference}">}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}\hspace*{1em}\hspace*{1em}{<\textbf{interp}\hspace*{1em}xml:id="{ref-church}">}church{</\textbf{interp}>}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}\hspace*{1em}\hspace*{1em}{<\textbf{interp}\hspace*{1em}xml:id="{ref-serv}">}servants{</\textbf{interp}>}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}\hspace*{1em}\hspace*{1em}{<\textbf{interp}\hspace*{1em}xml:id="{ref-cook}">}cooking{</\textbf{interp}>}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}\hspace*{1em}{</\textbf{interpGrp}>}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}{</\textbf{p}>}\mbox{}\newline 
\hspace*{1em}{</\textbf{div}>}\mbox{}\newline 
{</\textbf{back}>}\end{shaded}\egroup\par \par Once these interpretation elements have been defined, they can be
linked with the parts of the text to which they apply in either or
both of two ways. The ana attribute can be used on
whichever element is appropriate:
\par\bgroup\ttfamily\small\selectfont \begin{shaded}\noindent\mbox{}{<\textbf{div}\hspace*{1em}n="{38}"\hspace*{1em}type="{chapter}">}\mbox{}\newline 
\hspace*{1em}{<\textbf{p}\hspace*{1em}ana="{#set-church #set-kitch}"\hspace*{1em}xml:id="{P38.1}">}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}{<\textbf{s}\hspace*{1em}ana="{#fig-apos}"\hspace*{1em}xml:id="{P38.1.1}">}Reader, I married him.{</\textbf{s}>}\mbox{}\newline 
\hspace*{1em}{</\textbf{p}>}\mbox{}\newline 
{</\textbf{div}>}\end{shaded}\egroup\par \noindent  
...
supplied.\par Alternatively, the \texttt{<interp>} elements can point to all the
parts of the text to which they apply, using their inst
attribute:
\par\bgroup\ttfamily\small\selectfont \begin{shaded}\noindent\mbox{}{<\textbf{interp}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}inst="{#P38.1.1}"\mbox{}\newline 
\hspace*{1em}\hspace*{1em}resp="{#LB-MSM}"\mbox{}\newline 
\hspace*{1em}\hspace*{1em}type="{figureOfSpeech}"\mbox{}\newline 
\hspace*{1em}\hspace*{1em}xml:id="{fig-apos-2}">}apostrophe{</\textbf{interp}>}\mbox{}\newline 
{<\textbf{interp}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}inst="{#P38.1}"\mbox{}\newline 
\hspace*{1em}\hspace*{1em}resp="{#LB-MSM}"\mbox{}\newline 
\hspace*{1em}\hspace*{1em}type="{scene-setting}"\mbox{}\newline 
\hspace*{1em}\hspace*{1em}xml:id="{set-church-2}">}church{</\textbf{interp}>}\mbox{}\newline 
{<\textbf{interp}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}inst="{#P38.1}"\mbox{}\newline 
\hspace*{1em}\hspace*{1em}resp="{#LB-MSM}"\mbox{}\newline 
\hspace*{1em}\hspace*{1em}type="{scene-setting}"\mbox{}\newline 
\hspace*{1em}\hspace*{1em}xml:id="{set-kitchen-2}">}kitchen{</\textbf{interp}>}\end{shaded}\egroup\par \par The \texttt{<interp>} is not limited to any particular type of
analysis, The literary analysis shown above is but one possibility;
one could equally well use \texttt{<interp>} to capture a linguistic
part-of-speech analysis. For example, the example sentence given in
section \textit{\hyperref[xatts]{8.3. Special kinds of Linking}} assumes a linguistic analysis which
might be represented as follows:
\par\bgroup\ttfamily\small\selectfont \begin{shaded}\noindent\mbox{}{<\textbf{interp}\hspace*{1em}type="{pos}"\hspace*{1em}xml:id="{NP1}">}noun phrase, singular{</\textbf{interp}>}\mbox{}\newline 
{<\textbf{interp}\hspace*{1em}type="{pos}"\hspace*{1em}xml:id="{VV1}">}inflected verb, present-tense singular{</\textbf{interp}>}\mbox{}\newline 
 ...\mbox{}\newline 
\end{shaded}\egroup\par 
\DivI[Technical Documentation]{Technical Documentation}\label{U5-techdoc}\par Although the focus of this document is on the use of the TEI
scheme for the encoding of existing ‘pre-electronic’
...
example. \par To facilitate this, the TEI Lite schema includes some elements for
marking features of technical documents in general, and of
XML-related documents in particular.
\DivII[Additional Elements for Technical Documents]{Additional Elements for Technical Documents}\par The following elements may be used to mark particular features of
technical documents:
\par The following example shows how these elements might be used to
...
\hspace*{1em}\hspace*{1em} GRTG = 'HELLO WORLD'\mbox{}\newline 
\hspace*{1em}\hspace*{1em} PRINT *, GRTG\mbox{}\newline 
\hspace*{1em}\hspace*{1em} END\mbox{}\newline 
\hspace*{1em}{</\textbf{eg}>}\mbox{}\newline 
{</\textbf{p}>}\mbox{}\newline 
{<\textbf{p}>}This simple example first declares a variable {<\textbf{ident}>}GRTG{</\textbf{ident}>}, in\mbox{}\newline 
 ...
 is then assigned.{</\textbf{p}>}\end{shaded}\egroup\par \par A formatting application, given a text like that above, can be
...
as \texttt{<ident>} greatly facilitates the
construction of a useful index.\par The \texttt{<formula>} element should be used to enclose a
...
notation attribute, as in the following example:
\par\bgroup\ttfamily\small\selectfont \begin{shaded}\noindent\mbox{}{<\textbf{formula}\hspace*{1em}notation="{tex}">} ⃥begin❴math❵E = mc^❴2❵⃥end❴math❵\mbox{}\newline 
{</\textbf{formula}>}\end{shaded}\egroup\par \par A particular problem arises when XML encoding is the
...
the document itself, and end-tags are highly likely to occur. One
      ...
      \texttt{&lt;} to represent each < character which marks
...
construct called a \emph{\texttt{CDATA} marked section},  as
in the following example:
\par\bgroup\ttfamily\small\selectfont \vskip 10pt\begin{shaded}
\obeylines\obeyspaces <p>A list should be encoded as follows:
<eg><![ CDATA [
   <list>
...
\textit{<!-- ... -->}\mbox{}\newline 
\hspace*{1em}{</\textbf{titlePage}>}\mbox{}\newline 
\hspace*{1em}{<\textbf{divGen}\hspace*{1em}type="{toc}"/>}\mbox{}\newline 
\hspace*{1em}{<\textbf{div}>}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}{<\textbf{head}>}Preface{</\textbf{head}>}\mbox{}\newline 
\textit{<!-- ... -->}\mbox{}\newline 
\hspace*{1em}{</\textbf{div}>}\mbox{}\newline 
{</\textbf{front}>}\mbox{}\newline 
{<\textbf{body}>}\mbox{}\newline 
...
{<\textbf{back}>}\mbox{}\newline 
\hspace*{1em}{<\textbf{div}>}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}{<\textbf{head}>}Appendix{</\textbf{head}>}\mbox{}\newline 
\textit{<!-- ... -->}\mbox{}\newline 
\hspace*{1em}{</\textbf{div}>}\mbox{}\newline 
\hspace*{1em}{<\textbf{divGen}\hspace*{1em}n="{Index}"\hspace*{1em}type="{index}"/>}\mbox{}\newline 
{</\textbf{back}>}\end{shaded}\egroup\par \par This example also demonstrates the use of the type
attribute to distinguish the different kinds of division to be
generated: in the first case a table of contents (a
\emph{toc}) and in the second an index.\par When an existing index or table of contents is to be encoded
(rather than one being generated) for some reason, the
\texttt{<list>} element discussed in section \textit{\hyperref[U5-lists]{11. Lists}}
should be used. 
\DivII[Index Generation]{Index Generation}\label{indexing}\par While production of a table of contents from a properly tagged
...
occurrences of elements such as \texttt{<term>} or \texttt{<name>} will
often be a good departure point for an index. \par The TEI schema provides a special purpose \texttt{<index>} tag which
may be used to mark both the parts of the document which should be
indexed, and how the indexing should be done.
\par For example, the second paragraph of this section might include
the following:\par\bgroup\ttfamily\small\selectfont \begin{shaded}\noindent\mbox{}...\mbox{}\newline 
 TEI lite also provides a special purpose {<\textbf{gi}>}index{</\textbf{gi}>} tag\mbox{}\newline 
\mbox{}\newline 
{<\textbf{index}>}\mbox{}\newline 
\hspace*{1em}{<\textbf{term}>}indexing{</\textbf{term}>}\mbox{}\newline 
{</\textbf{index}>}\mbox{}\newline 
{<\textbf{index}>}\mbox{}\newline 
\hspace*{1em}{<\textbf{term}>}index (tag){</\textbf{term}>}\mbox{}\newline 
\hspace*{1em}{<\textbf{index}>}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}{<\textbf{term}>}use in index generation{</\textbf{term}>}\mbox{}\newline 
\hspace*{1em}{</\textbf{index}>}\mbox{}\newline 
{</\textbf{index}>}\mbox{}\newline 
 which may be used ...\end{shaded}\egroup\par \par The \texttt{<index>} element can also be used to provide a form of
...
\emph{deus}, \emph{se}, and as the
subject of \emph{confiteor} [in inflectional form
number 227]), to Jupiter-in-the-guise-of-a-bull (as
\emph{imago tauri fallacis} and the subject of
\emph{teneo}), and so on.\footnote{The
analysis is taken, with permission, from Willard McCarty and Burton
Wright, \textit{An Analytical Onomasticon to the Metamorphoses of Ovid}
(Princeton: Princeton University Press, forthcoming).  Some
simplifications have been undertaken.}\par\bgroup\ttfamily\small\selectfont \begin{shaded}\noindent\mbox{}{<\textbf{l}\hspace*{1em}n="{3.001}">}iamque deus posita fallacis imagine tauri{</\textbf{l}>}\mbox{}\newline 
{<\textbf{l}\hspace*{1em}n="{3.002}">}se confessus erat Dictaeaque rura tenebat{</\textbf{l}>}\end{shaded}\egroup\par \noindent  This need might be met using the \texttt{<note>} element
discussed in section in \textit{\hyperref[U5-notes]{7. Notes}}, or with the \texttt{<interp>}
element discussed in section \textit{\hyperref[U5-anal]{15. Interpretation and  Analysis}}. Here we demonstrate
how it might also be satisfied by using the \texttt{<index>} element.\par We assume that the object is to generate more than one index: one
for names of deities (called dn), another for
onomastic references (called on),  a third for pronominal
references (called pr) and so forth. One way of
achieving this might be as follows:
\par\bgroup\ttfamily\small\selectfont \begin{shaded}\noindent\mbox{}{<\textbf{l}\hspace*{1em}n="{3.001}">}iamque deus posita fallacis imagine tauri\mbox{}\newline 
{<\textbf{index}\hspace*{1em}indexName="{dn}">}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}{<\textbf{term}>}Iuppiter{</\textbf{term}>}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}{<\textbf{index}>}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}\hspace*{1em}{<\textbf{term}>}deus{</\textbf{term}>}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}{</\textbf{index}>}\mbox{}\newline 
\hspace*{1em}{</\textbf{index}>}\mbox{}\newline 
\hspace*{1em}{<\textbf{index}\hspace*{1em}indexName="{on}">}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}{<\textbf{term}>}Iuppiter (taurus){</\textbf{term}>}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}{<\textbf{index}>}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}\hspace*{1em}{<\textbf{term}>}imago tauri fallacis{</\textbf{term}>}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}{</\textbf{index}>}\mbox{}\newline 
\hspace*{1em}{</\textbf{index}>}\mbox{}\newline 
{</\textbf{l}>}\mbox{}\newline 
...
\hspace*{1em}\hspace*{1em}{<\textbf{term}>}Iuppiter{</\textbf{term}>}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}{<\textbf{index}>}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}\hspace*{1em}{<\textbf{term}>}se{</\textbf{term}>}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}{</\textbf{index}>}\mbox{}\newline 
\hspace*{1em}{</\textbf{index}>}\mbox{}\newline 
\hspace*{1em}{<\textbf{index}\hspace*{1em}indexName="{v}">}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}{<\textbf{term}>}Iuppiter{</\textbf{term}>}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}{<\textbf{index}>}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}\hspace*{1em}{<\textbf{term}>}confiteor (v227){</\textbf{term}>}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}{</\textbf{index}>}\mbox{}\newline 
\hspace*{1em}{</\textbf{index}>}\mbox{}\newline 
...
the \texttt{<term>} element it contains; the \texttt{<term>} elements
nested within the secondary \texttt{<index>} element in each case
provide a secondary keyword. The actual reference will be taken from the context
in which the \texttt{<index>} element appears, i.e. in this case the
identifier of the \texttt{<l>} element containing it. 
\DivII[Addresses]{Addresses}\par The \texttt{<address>} element is used to mark a postal address of
any kind. It contains one or more \texttt{<addrLine>} elements, one for
each line of the address.
\par Here is a simple example:
\par\bgroup\ttfamily\small\selectfont \begin{shaded}\noindent\mbox{}{<\textbf{address}>}\mbox{}\newline 
\hspace*{1em}{<\textbf{addrLine}>}Computer Center (M/C 135){</\textbf{addrLine}>}\mbox{}\newline 
\hspace*{1em}{<\textbf{addrLine}>}1940 W. Taylor, Room 124{</\textbf{addrLine}>}\mbox{}\newline 
\hspace*{1em}{<\textbf{addrLine}>}Chicago, IL 60612-7352{</\textbf{addrLine}>}\mbox{}\newline 
\hspace*{1em}{<\textbf{addrLine}>}U.S.A.{</\textbf{addrLine}>}\mbox{}\newline 
{</\textbf{address}>}\end{shaded}\egroup\par \par The individual parts of an address may be further distinguished by
 using the \texttt{<name>} element discussed above (section \textit{\hyperref[nomen]{10.1. Names and Referring Strings}}).
\par\bgroup\ttfamily\small\selectfont \begin{shaded}\noindent\mbox{}{<\textbf{address}>}\mbox{}\newline 
\hspace*{1em}{<\textbf{addrLine}>}Computer Center (M/C 135){</\textbf{addrLine}>}\mbox{}\newline 
\hspace*{1em}{<\textbf{addrLine}>}1940 W. Taylor, Room 124{</\textbf{addrLine}>}\mbox{}\newline 
\hspace*{1em}{<\textbf{addrLine}>}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}{<\textbf{name}\hspace*{1em}type="{city}">}Chicago{</\textbf{name}>}, IL 60612-7352{</\textbf{addrLine}>}\mbox{}\newline 
\hspace*{1em}{<\textbf{addrLine}>}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}{<\textbf{name}\hspace*{1em}type="{country}">}USA{</\textbf{name}>}\mbox{}\newline 
\hspace*{1em}{</\textbf{addrLine}>}\mbox{}\newline 
{</\textbf{address}>}\end{shaded}\egroup\par 
\DivI[Character Sets, Diacritics, etc.]{Character Sets, Diacritics, etc.}\label{U5-chars}\par With the advent of XML and its adoption of Unicode as the required
     ...
     systems. \par There are two important exceptions: the characters & and < may not be
...
\par\bgroup\ttfamily\small\selectfont \begin{shaded}\noindent\mbox{}{<\textbf{titlePage}\hspace*{1em}rend="{Roman}">}\mbox{}\newline 
\hspace*{1em}{<\textbf{docTitle}>}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}{<\textbf{titlePart}\hspace*{1em}type="{main}">} PARADISE REGAIN'D. A POEM In IV {<\textbf{hi}>}BOOKS{</\textbf{hi}>}.\mbox{}\newline 
\hspace*{1em}\hspace*{1em}{</\textbf{titlePart}>}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}{<\textbf{titlePart}>} To which is added {<\textbf{title}>}SAMSON AGONISTES{</\textbf{title}>}.\mbox{}\newline 
\hspace*{1em}\hspace*{1em}{</\textbf{titlePart}>}\mbox{}\newline 
\hspace*{1em}{</\textbf{docTitle}>}\mbox{}\newline 
\hspace*{1em}{<\textbf{byline}>}The Author {<\textbf{docAuthor}>}JOHN MILTON{</\textbf{docAuthor}>}\mbox{}\newline 
\hspace*{1em}{</\textbf{byline}>}\mbox{}\newline 
\hspace*{1em}{<\textbf{docImprint}>}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}{<\textbf{name}>}LONDON{</\textbf{name}>},\mbox{}\newline 
\hspace*{1em}\hspace*{1em} Printed by {<\textbf{name}>}J.M.{</\textbf{name}>}\mbox{}\newline 
\hspace*{1em}\hspace*{1em} for {<\textbf{name}>}John Starkey{</\textbf{name}>}\mbox{}\newline 
\hspace*{1em}\hspace*{1em} at the {<\textbf{name}>}Mitre{</\textbf{name}>}\mbox{}\newline 
\hspace*{1em}\hspace*{1em} in {<\textbf{name}>}Fleetstreet{</\textbf{name}>},\mbox{}\newline 
\hspace*{1em}\hspace*{1em} near {<\textbf{name}>}Temple-Bar.{</\textbf{name}>}\mbox{}\newline 
\hspace*{1em}{</\textbf{docImprint}>}\mbox{}\newline 
\hspace*{1em}{<\textbf{docDate}>}MDCLXXI{</\textbf{docDate}>}\mbox{}\newline 
{</\textbf{titlePage}>}\end{shaded}\egroup\par \noindent \par\bgroup\ttfamily\small\selectfont \begin{shaded}\noindent\mbox{}{<\textbf{titlePage}>}\mbox{}\newline 
\hspace*{1em}{<\textbf{docTitle}>}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}{<\textbf{titlePart}\hspace*{1em}type="{main}">} Lives of the Queens of England, from the Norman\mbox{}\newline 
\hspace*{1em}\hspace*{1em}\hspace*{1em}\hspace*{1em} Conquest;{</\textbf{titlePart}>}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}{<\textbf{titlePart}\hspace*{1em}type="{sub}">}with anecdotes of their courts.\mbox{}\newline 
\hspace*{1em}\hspace*{1em}{</\textbf{titlePart}>}\mbox{}\newline 
\hspace*{1em}{</\textbf{docTitle}>}\mbox{}\newline 
\hspace*{1em}{<\textbf{titlePart}>}Now first published from Official Records\mbox{}\newline 
...
\hspace*{1em}{<\textbf{docEdition}>}New edition, with corrections and\mbox{}\newline 
\hspace*{1em}\hspace*{1em} additions{</\textbf{docEdition}>}\mbox{}\newline 
\hspace*{1em}{<\textbf{byline}>}By {<\textbf{docAuthor}>}Agnes Strickland{</\textbf{docAuthor}>}\mbox{}\newline 
\hspace*{1em}{</\textbf{byline}>}\mbox{}\newline 
\hspace*{1em}{<\textbf{epigraph}>}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}{<\textbf{q}>}The treasures of antiquity laid up in old\mbox{}\newline 
\hspace*{1em}\hspace*{1em}\hspace*{1em}\hspace*{1em} historic rolls, I opened.{</\textbf{q}>}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}{<\textbf{bibl}>}BEAUMONT{</\textbf{bibl}>}\mbox{}\newline 
\hspace*{1em}{</\textbf{epigraph}>}\mbox{}\newline 
\hspace*{1em}{<\textbf{docImprint}>}Philadelphia: Blanchard and Lea{</\textbf{docImprint}>}\mbox{}\newline 
\hspace*{1em}{<\textbf{docDate}>}1860.{</\textbf{docDate}>}\mbox{}\newline 
{</\textbf{titlePage}>}\end{shaded}\egroup\par 
...
\hspace*{1em}{<\textbf{head}>}To the Right Honourable {<\textbf{name}>}JOHN Lord Viscount\mbox{}\newline 
\hspace*{1em}\hspace*{1em}\hspace*{1em}\hspace*{1em} BRACLY{</\textbf{name}>}, Son and Heir apparent to the Earl of\mbox{}\newline 
\hspace*{1em}\hspace*{1em} Bridgewater, &c.{</\textbf{head}>}\mbox{}\newline 
\hspace*{1em}{<\textbf{salute}>}MY LORD,{</\textbf{salute}>}\mbox{}\newline 
\hspace*{1em}{<\textbf{p}>}THis {<\textbf{hi}>}Poem{</\textbf{hi}>}, which receiv'd its first occasion of\mbox{}\newline 
\hspace*{1em}\hspace*{1em} Birth from your Self, and others of your Noble Family ....\mbox{}\newline 
\hspace*{1em}\hspace*{1em} and as in this representation your attendant\mbox{}\newline 
\hspace*{1em}{<\textbf{name}>}Thyrsis{</\textbf{name}>}, so now in all reall expression{</\textbf{p}>}\mbox{}\newline 
\hspace*{1em}{<\textbf{closer}>}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}{<\textbf{salute}>}Your faithfull, and most humble servant{</\textbf{salute}>}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}{<\textbf{signed}>}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}\hspace*{1em}{<\textbf{name}>}H. LAWES.{</\textbf{name}>}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}{</\textbf{signed}>}\mbox{}\newline 
\hspace*{1em}{</\textbf{closer}>}\mbox{}\newline 
{</\textbf{div}>}\end{shaded}\egroup\par 
...
of one or more \texttt{<p>}s.  Others are grouped:
\begin{itemize}

\item Elements whose names end in \emph{Stmt}(for
statement) usually enclose a group of elements recording some
structured information.
\item Elements whose names end in \emph{Decl} (for
declaration) enclose information about specific encoding practices.
\item Elements whose names end in \emph{Desc} (for
description) contain a prose description.
\end{itemize} 
\DivII[The File Description]{The File Description}\par The \texttt{<fileDesc>} element is mandatory. It contains a full
bibliographic description of the file with the following elements:
\par    A minimal header has the following structure:
...
\DivIII[The Title Statement]{The Title Statement}\par The following elements can be used in the \texttt{<titleStmt>}:
\par    It is recommended that the title should distinguish the
computer file from the source text, for example:
\par\bgroup\ttfamily\small\selectfont \vskip 10pt\begin{shaded}
\obeylines\obeyspaces [title of source]: a machine readable transcription
[title of source]: electronic edition
A machine readable version of: [title of source]\end{shaded}
\par\egroup 

 The \texttt{<respStmt>} element contains the following
subcomponents:
   Example:
\par\bgroup\ttfamily\small\selectfont \begin{shaded}\noindent\mbox{}{<\textbf{titleStmt}>}\mbox{}\newline 
\hspace*{1em}{<\textbf{title}>}Two stories by Edgar Allen Poe: a machine readable\mbox{}\newline 
\hspace*{1em}\hspace*{1em} transcription{</\textbf{title}>}\mbox{}\newline 
...
\DivIII[The Edition Statement]{The Edition Statement}\par The \texttt{<editionStmt>} groups information relating to one
edition of a text (where \emph{edition} is used as
elsewhere in bibliography), and may include the following elements:
\par Example:
\par\bgroup\ttfamily\small\selectfont \begin{shaded}\noindent\mbox{}{<\textbf{editionStmt}>}\mbox{}\newline 
\hspace*{1em}{<\textbf{edition}\hspace*{1em}n="{U2}">}Third draft, substantially revised\mbox{}\newline 
\hspace*{1em}{<\textbf{date}>}1987{</\textbf{date}>}\mbox{}\newline 
\hspace*{1em}{</\textbf{edition}>}\mbox{}\newline 
{</\textbf{editionStmt}>}\end{shaded}\egroup\par \par Determining exactly what constitutes a new edition of an
electronic text is left to the encoder.
\DivIII[The Extent Statement]{The Extent Statement}\par The \texttt{<extent>} statement describe the approximate size of a
file.\par Example:
\par\bgroup\ttfamily\small\selectfont \begin{shaded}\noindent\mbox{}{<\textbf{extent}>}4532 bytes{</\textbf{extent}>}\end{shaded}\egroup\par 
\DivIII[The Publication Statement]{The Publication Statement}\par The \texttt{<publicationStmt>} is mandatory. It may contain a
simple prose description or groups of the elements described below:
\par At least one of these three elements must be present, unless the
...
\hspace*{1em}{<\textbf{idno}\hspace*{1em}type="{ISBN}">} 0-19-254705-5{</\textbf{idno}>}\mbox{}\newline 
\hspace*{1em}{<\textbf{availability}>}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}{<\textbf{p}>}Copyright 1989, Oxford University\mbox{}\newline 
\hspace*{1em}\hspace*{1em}\hspace*{1em}\hspace*{1em} Press{</\textbf{p}>}\mbox{}\newline 
\hspace*{1em}{</\textbf{availability}>}\mbox{}\newline 
{</\textbf{publicationStmt}>}\end{shaded}\egroup\par 
\DivIII[Series and Notes Statements]{Series and Notes Statements}\par The \texttt{<seriesStmt>} element groups information about the series, if
any, to which a publication belongs. It may contain \texttt{<title>},
\texttt{<idno>}, or \texttt{<respStmt>} elements.\par The \texttt{<notesStmt>}, if used, contains one or more \texttt{<note>}
...
\DivIII[The Source Description]{The Source Description}\par The \texttt{<sourceDesc>} is a mandatory element which records
...
\hspace*{1em}{<\textbf{bibl}>}The first folio of Shakespeare, prepared by Charlton\mbox{}\newline 
\hspace*{1em}\hspace*{1em} Hinman (The Norton Facsimile, 1968){</\textbf{bibl}>}\mbox{}\newline 
{</\textbf{sourceDesc}>}\end{shaded}\egroup\par \noindent \par\bgroup\ttfamily\small\selectfont \begin{shaded}\noindent\mbox{}{<\textbf{sourceDesc}>}\mbox{}\newline 
\hspace*{1em}{<\textbf{bibl}>}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}{<\textbf{author}>}CNN Network News{</\textbf{author}>}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}{<\textbf{title}>}News headlines{</\textbf{title}>}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}{<\textbf{date}>}12 Jun 1989{</\textbf{date}>}\mbox{}\newline 
\hspace*{1em}{</\textbf{bibl}>}\mbox{}\newline 
{</\textbf{sourceDesc}>}\end{shaded}\egroup\par 
\DivII[The Encoding Description]{The Encoding Description}\par The \texttt{<encodingDesc>} element specifies the methods and
...
\DivIII[Project and Sampling Descriptions]{Project and Sampling Descriptions}\par Examples of \texttt{<projectDesc>} and \texttt{<samplingDesc>}:
\par\bgroup\ttfamily\small\selectfont \begin{shaded}\noindent\mbox{}{<\textbf{encodingDesc}>}\mbox{}\newline 
\hspace*{1em}{<\textbf{projectDesc}>}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}{<\textbf{p}>}Texts collected for use in the Claremont\mbox{}\newline 
\hspace*{1em}\hspace*{1em}\hspace*{1em}\hspace*{1em} Shakespeare Clinic, June 1990.\mbox{}\newline 
\hspace*{1em}\hspace*{1em}{</\textbf{p}>}\mbox{}\newline 
\hspace*{1em}{</\textbf{projectDesc}>}\mbox{}\newline 
{</\textbf{encodingDesc}>}\end{shaded}\egroup\par \noindent \par\bgroup\ttfamily\small\selectfont \begin{shaded}\noindent\mbox{}{<\textbf{encodingDesc}>}\mbox{}\newline 
\hspace*{1em}{<\textbf{samplingDecl}>}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}{<\textbf{p}>}Samples of 2000 words taken from the beginning\mbox{}\newline 
\hspace*{1em}\hspace*{1em}\hspace*{1em}\hspace*{1em} of the text{</\textbf{p}>}\mbox{}\newline 
\hspace*{1em}{</\textbf{samplingDecl}>}\mbox{}\newline 
{</\textbf{encodingDesc}>}\end{shaded}\egroup\par 
...
\hspace*{1em}{<\textbf{p}>}The part of speech analysis applied throughout\mbox{}\newline 
\hspace*{1em}\hspace*{1em} section 4 was added by hand and has not been\mbox{}\newline 
\hspace*{1em}\hspace*{1em} checked.{</\textbf{p}>}\mbox{}\newline 
\hspace*{1em}{<\textbf{p}>}Errors in transcription controlled by using the\mbox{}\newline 
\hspace*{1em}\hspace*{1em} WordPerfect spelling checker.{</\textbf{p}>}\mbox{}\newline 
\hspace*{1em}{<\textbf{p}>}All words converted to Modern American spelling\mbox{}\newline 
\hspace*{1em}\hspace*{1em} using Webster's 9th Collegiate dictionary.{</\textbf{p}>}\mbox{}\newline 
\hspace*{1em}{<\textbf{p}>}All quotation marks converted to entity\mbox{}\newline 
\hspace*{1em}\hspace*{1em} references odq and cdq.{</\textbf{p}>}\mbox{}\newline 
{</\textbf{editorialDecl}>}\end{shaded}\egroup\par 
\DivIII[Reference and Classification Declarations]{Reference and Classification Declarations}\par The \texttt{<refsDecl>} element is used to document the way in
which any standard referencing scheme built into the encoding works.
In its simplest form, it consists of prose description.\par Example:
\par\bgroup\ttfamily\small\selectfont \begin{shaded}\noindent\mbox{}{<\textbf{refsDecl}>}\mbox{}\newline 
\hspace*{1em}{<\textbf{p}>}The {<\textbf{att}>}n{</\textbf{att}>} attribute on each {<\textbf{gi}>}div{</\textbf{gi}>} contains the\mbox{}\newline 
\hspace*{1em}\hspace*{1em} canonical reference for each such division in the form\mbox{}\newline 
\hspace*{1em}\hspace*{1em} XX.yyy where XX is the book number in roman numeral and\mbox{}\newline 
\hspace*{1em}\hspace*{1em} yyy is the section number in arabic.{</\textbf{p}>}\mbox{}\newline 
{</\textbf{refsDecl}>}\end{shaded}\egroup\par \par The \texttt{<classDecl>} element groups together definitions or
...
\par    In the simplest case, the taxonomy may be defined by a
bibliographic reference, as in the following example:
\par\bgroup\ttfamily\small\selectfont \begin{shaded}\noindent\mbox{}{<\textbf{classDecl}>}\mbox{}\newline 
\hspace*{1em}{<\textbf{taxonomy}\hspace*{1em}xml:id="{LC-SH}">}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}{<\textbf{bibl}>}Library of Congress Subject Headings\mbox{}\newline 
\hspace*{1em}\hspace*{1em}{</\textbf{bibl}>}\mbox{}\newline 
\hspace*{1em}{</\textbf{taxonomy}>}\mbox{}\newline 
{</\textbf{classDecl}>}\end{shaded}\egroup\par \par Alternatively, or in addition, the encoder may define a special
...
\hspace*{1em}{<\textbf{name}\hspace*{1em}type="{place}">}Taos, New Mexico{</\textbf{name}>}\mbox{}\newline 
{</\textbf{creation}>}\end{shaded}\egroup\par \par The \texttt{<langUsage>} element is useful where a text contains many
different languages. It may contain \texttt{<language>} elements to
document each particular language used:

an example is needed.
\par The \texttt{<textClass>} element classifies a text by reference to
the system or systems defined by the \texttt{<classDecl>} element, and
contains one or more of the following elements:
\par The element \texttt{<keywords>} contains a list of keywords or
phrases identifying the topic or nature of a text. The attribute
scheme links these to the classification system
defined in
\texttt{<taxonomy>}.
\par\bgroup\ttfamily\small\selectfont \begin{shaded}\noindent\mbox{}{<\textbf{textClass}>}\mbox{}\newline 
\hspace*{1em}{<\textbf{keywords}\hspace*{1em}scheme="{LCSH}">}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}{<\textbf{list}>}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}\hspace*{1em}{<\textbf{item}>}English literature -- History and criticism --\mbox{}\newline 
\hspace*{1em}\hspace*{1em}\hspace*{1em}\hspace*{1em}\hspace*{1em}\hspace*{1em} Data processing.{</\textbf{item}>}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}\hspace*{1em}{<\textbf{item}>}English literature -- History and criticism --\mbox{}\newline 
\hspace*{1em}\hspace*{1em}\hspace*{1em}\hspace*{1em}\hspace*{1em}\hspace*{1em} Theory etc.{</\textbf{item}>}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}\hspace*{1em}{<\textbf{item}>}English language -- Style -- Data\mbox{}\newline 
\hspace*{1em}\hspace*{1em}\hspace*{1em}\hspace*{1em}\hspace*{1em}\hspace*{1em} processing.{</\textbf{item}>}\mbox{}\newline 
\hspace*{1em}\hspace*{1em}{</\textbf{list}>}\mbox{}\newline 
\hspace*{1em}{</\textbf{keywords}>}\mbox{}\newline 
{</\textbf{textClass}>}\end{shaded}\egroup\par 
\DivII[The Revision Description]{The Revision Description}\par The \texttt{<revisionDesc>} element provides a change log in which
each change made to a text may be recorded. The log may be recorded as
a sequence of \texttt{<change>} elements each of which contains
a brief description of the change. The attributes date and
who may be used to identify when the change was carried out
and the agency responsible for it. \par Example:
\par\bgroup\ttfamily\small\selectfont \begin{shaded}\noindent\mbox{}{<\textbf{revisionDesc}>}\mbox{}\newline 
\hspace*{1em}{<\textbf{change}\hspace*{1em}when="{1991-03-06}"\hspace*{1em}who="{EMB}">}File format updated{</\textbf{change}>}\mbox{}\newline 
\hspace*{1em}{<\textbf{change}\hspace*{1em}when="{1990-05-25}"\hspace*{1em}who="{EMB}">}Stuart's corrections entered{</\textbf{change}>}\mbox{}\newline 
{</\textbf{revisionDesc}>}\end{shaded}\egroup\par 
\DivI[List of Elements Described]{List of Elements Described}\label{U5-taglist}\par The following list shows all the elements defined for the TEI
