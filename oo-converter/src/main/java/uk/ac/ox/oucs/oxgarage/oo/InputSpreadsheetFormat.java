...
public enum InputSpreadsheetFormat {
	...
	SXC("sxc", "application/vnd.sun.xml.calc", "OpenOffice.org 1.0 Spreadsheet (.sxc)", "sxc", true, 4),
	XLS("xls", "application/vnd.ms-excel", "Microsoft Excel Document (.xls)", "xls", true, 5),
	XLSX("xlsx", "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet", "Microsoft Excel Document (.xlsx)", "xlsx", true, 5),
