...
<div id="content">
	...
	<div id="conversionFormDiv" style="display:none;">
		...
		<form id="conversionForm" method="POST" name="conversionForm" enctype="multipart/form-data">
			<div id="fileInput">
				<strong>Select file to convert:<a href="helpFiles/convert.html?height=300&with=450" title="Help" class="thickbox helpLink">?</a> </strong><br /><br /><br/>
				<input type="file" id="fileToConvert" name="fileToConvert" /><br /><br/>
				<a href="#" id="showMore">+ Show advanced options<a href="helpFiles/moreOptions.html?height=300&with=450" title="Help" class="thickbox helpLink">?</a></a>
			</div>
			<div id="imagesInput">
				<strong>Upload images:<a href="helpFiles/images.html?height=300&with=450" title="Help" class="thickbox helpLink">?</a> </strong><br/>
	...
	<div class="divContent" id="conversionsListContainer">
		...
		<ul id="conversionsList" type="none">
		</ul>
	</div>
	<div class="divContent" id="conversionsPathsListContainer" style="display:none;">
		...
		<ul id="conversionsPathsList" type="none">
		</ul>
	</div>
</div>
<div id="footer" >
